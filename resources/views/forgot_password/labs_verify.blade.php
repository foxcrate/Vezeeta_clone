...
<div class="back-ground" style="padding-top:80px;">
    <div class="container row no-gutters bg-message card ml-auto mr-auto" style="flex-direction: row; margin-top:120px; margin-bottom:50px;">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <h6 class="ml-auto mr-auto col-10">For your security labs History wants to make sure its really you. labs History will send a text message with a 6-digit verification code.</6>
            <div class="reca-div mt-4">
                <div id="mobile-number" class="ml-auto mr-auto col-8 mb-5 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{$labs['phoneNumber']}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2 mb-2">labs History Will Send a Verification code to {{$labs['phoneNumber']}}</div>
            ...
            <br/><a  style="display:none; color:white;" class="mt-3 btn btn-success suc-Reg text-white" href="{{route('labs_verifcationCode',$labs['id'])}}">{{$labs['id']}} </a>
            <div class="row">
                ...
                function codevervcation(){
                    console.log('login');
                        ...
                        confirmationResult.confirm(code).then(function(result){
                            ...
                            // window.location = "https://localhost/labs_history_last_update/public/verficationCode/" + $(".suc-Reg").text();
                            window.location = $("#config_app").text()+"Phistory/public/labs/confirm/password/" + $(".suc-Reg").text();
