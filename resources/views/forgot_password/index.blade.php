...
<div class="back-ground" style="padding-top:80px;">
    <div class="container row no-gutters bg-message card ml-auto mr-auto" style="flex-direction: row; margin-top:120px; margin-bottom:50px;">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <br/><a  style="display:none; color:white;" class="mt-3 btn btn-success suc-Reg text-white" href="{{route('patient_verifcationCode',$patient['id'])}}">{{$patient['id']}} </a>
            <div class="row">
                ...
                function codevervcation(){
                    console.log('login');
                        ...
                        confirmationResult.confirm(code).then(function(result){
                            ...
                            window.location = $("#config_app").text()+"Phistory/public/patient/confirm/password/" + $(".suc-Reg").text();
