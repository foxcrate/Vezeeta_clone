    ...
    <div class="container row no-gutters bg-message card ml-auto mr-auto" style="flex-direction: row; margin-top:120px; margin-bottom:50px;">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <div class="reca-div mt-4">
                <div id="mobile-number" class="ml-auto mr-auto col-8 mb-5 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{ $doctor['phoneNumber']}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2 mb-2">patient History Will Send a Verification code to {{$doctor['phoneNumber']}}</div>
            ...
            <br/><a  style="display:none; color:white;" class="mt-3 btn btn-success suc-Reg text-white" href="{{route('patient_verifcationCode',$doctor['id'])}}">{{$doctor['id']}} </a>
            <div class="row">
                    ...
                    console.log('login');
                        ...
                        confirmationResult.confirm(code).then(function(result){
                            console.log('success register');
                             window.location = $("#config_app").text()+"Phistory/public/doctor/confirm/password/" + $(".suc-Reg").text();
                            //window.location = "https://phistory.life/Phistory/public/patient/confirm/password/" + $(".suc-Reg").text();
