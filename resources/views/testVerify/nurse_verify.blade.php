    ...
    <div class="container row no-gutters bg-message card ml-auto mr-auto mb-5" style="flex-direction: row; margin-top:120px">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <div class="reca-div mt-4">
                <div id="mobile-number" class="ml-auto mr-auto col-8 mb-5 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{session()->get('nurese')->idCode}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2 mb-2">Patient History Will Send a Verification code to {{session()->get('nurese')->idCode}}</div>
            ...
            <p style="display:none" class="mt-3 alert alert-success suc-Reg">Success Reigster <a  id="nurse_id" href="{{route('verifcationCodenurse')}}">{{session()->get('nurese')->idCode}}</a></p>
            <div class="row">
                ...
                function codevervcation(){
                    console.log('login');
                        ...
                        confirmationResult.confirm(code).then(function(result){
                            ...
                            //window.location = "https://phistory.life/Phistory/public/verficationCode/nurse/" + $("#nurse_id").text();
                            window.location = $("#config_app").text()+"Phistory/public/verficationCode/nurse/" + $("#nurse_id").text();
