    ...
    <div class="container row no-gutters bg-message card ml-auto mr-auto mb-5" style="flex-direction: row; margin-top:120px">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <div class="reca-div mt-4">
                <div id="mobile-number" class="ml-auto mr-auto col-8 mb-5 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{session()->get('hosptail')->idCode}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2 mb-2">Patient History Will Send a Verification code to {{session()->get('hosptail')->idCode}}</div>
            ...
            <p  style="display:none" class="mt-3 alert alert-success suc-Reg">Success Reigster <a id="hos_id" href="{{route('hosptail_verifcationCode')}}">{{session()->get('hosptail')->idCode}}</a></p>
            <div class="row">
                ...
                {{-- <button style="position: relative;bottom: 10px;display:none;" class="btn btn-success mt-3 mb-3" onclick="r_send()" id="r-send" type="submit"><i class="fa fa-chav mr-2" aria-hidden="true"></i>R-send</button> --}}
                <div class="col-12 show-verify" style="display: none">
                    <input class="form-control col-6 mt-5" type="text" id="verify-code" maxLength="6" size="1" min="0" max="9" pattern="[0-9]" />
                    <div class="row">
                        <div class="col-4">
                ...
                function codevervcation(){
                    console.log('login');
                        ...
                        confirmationResult.confirm(code).then(function(result){
                            ...
                            window.location = {!! json_encode( config('app.url') ) !!}+"/public/verficationCode/hosptail/" + $("#hos_id").text();
                            //window.location = "https://phistory.life/Phistory/public/verficationCode/hosptail/" + $("#hos_id").text();
