...
<div class="back-ground" style="padding-top:50px;">
    <div class="container row no-gutters bg-message card ml-auto mr-auto mb-5" style="flex-direction: row; margin-top:120px">
        ...
        <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
            ...
            <p style="display:none" class="mt-3 alert alert-success suc-Reg">Success Reigster <a  id="doctor_id" href="{{route('verifcationCodedoctor_hosptail_branch',[$doctor->id,$hosptail->id,$branch->id])}}">{{$doctor['id']}}</a></p>
            <p id = "hosptail_id" style="display:none">{{$hosptail->id}}</p>
            <p id = "branch_id" style="display:none">{{$branch->id}}</p>
            <div class="row">
                <div class="col-12 show-verify" style="display: none">
                    ...
                    <button class="btn btn-success mt-3 mb-3" onclick="r_send()" id="r-send" type="submit"><i class="fa fa-chav mr-2" aria-hidden="true"></i>r-send</button>
