...
@if(session()->get('updatePhoneNumber'))
        ...
        <div class="container row no-gutters bg-message card ml-auto mr-auto" style="flex-direction: row; margin-top:120px; margin-bottom:50px;">
            ...
            <div class="col-lg-6 order-lg-2 mt-5 pt-5 mb-5">
                ...
                <div class="reca-div mt-4">
                    <div id="mobile-number" class="ml-auto mr-auto col-8 mb-5 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{session()->get('updatePhoneNumber')}}</div>
                    <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                    <div id="mobile-number" class="mt-2 mb-2">Patient History Will Send a Verification code to {{session()->get('updatePhoneNumber')}}</div>
                    ...
                    <div class="col-12 show-verify" style="display: none">
                        <span class="p_id d-none">{{ $online_doctor->id }}</span>
        ...
        console.log('login');
            ...
            confirmationResult.confirm(code).then(function(result){
                console.log('success register');
                    window.location = $("#config_app").text()+"/public/edit/verficationCode/online_doctor/" + $(".p_id").text();
