    ...
    <div id="page-content-wrapper">
        <div class="main-content" id="panel">
            ...
            <div class="container mt-5">
                <div class="row">
                    @if($clinic)
                        @foreach($clinic->clinicDoctorAppoiemnts as $clinic)
                            <div class="col-md-6 ml-auto mr-auto mb-4 pharmacy_item" data-lat="{{$clinic->latitude}}" data-lng="{{$clinic->longitude}}" data-distance=".distance_{{$clinic->id}}">
                                <div class="card-finder">
                                    <div class="row mr-auto ml-auto">
                                        <div class="mb-3 pb-2 mr-auto ml-auto">
                                            ...
                                            @else
                                                <img width="75" height="75" class="rounded-circle" alt="Image placeholder" src="{{ $clinic->image }}">
                                            @endif
                                        </div>
                                ...
                                <div class="card-finder">
                                    <div class="row mr-auto ml-auto mt-2">
                                        <div class="row h5 text-dark text-capitalize mb-2">
                                            ...
                                            <div class="col-9 ml-2">Fees: {{$clinic->fees}} EGP</div>
                                        </div>
                                        {{-- <div class="row h5 text-dark text-capitalize mb-2">
                                        ...
                                        <div class="row h5 text-dark text-capitalize mt-3 mb-2">
                                            ...
                                            <div class="col-10 ml-2">{{$clinic->address}}</div>
                                        </div>
                                        {{-- <div class="row">
                                            @php
