...
<section class="signup-step-container col-md-6 container bg-registr">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <form action="{{route('nurse.postRegister')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12 form-group">
                            <label class="h6 font-weight-bold">Nurse Name <i class="fa fa-star-of-life star"></i></label>
                            <input onkeypress="return /[a-z ]/i.test(event.key)" type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" placeholder="Nurse Full Name"style="text-transform:capitalize">
                            @error('name')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h6 font-weight-bold">Nationality <i class="fa fa-star-of-life star"></i></label>
                                <input type="text" name="Nationality" class="form-control @error('Nationality') is-invalid @enderror" placeholder="Nationality">
                                @error('Nationality')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h6 font-weight-bold">National Id <i class="fa fa-star-of-life star"></i></label>
                                <input type="text" name="national_id" class="form-control @error('national_id') is-invalid @enderror" placeholder="National Id">
                                @error('national_id')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input id="txtEmailId" type="email" name="email" class="form-control @error('email') is-invalid @enderror">
