...
<div class="bg-waves">
    ...
    <div class="container">
        ...
        <div class="col-2 mt-2">
            ...
            @else
                <img src="{{$nurse->image}}" class="rounded-circle" width="120" height="120">
            @endif
        </div>
        <div class="col-8">
            <h4 class="text-dark mt-3 mb-3 font-weight-bold">{{$nurse->name }}</h4>
            <h5 class="text-dark">{{$nurse->idCode}}</h5>
            <div class="row mt-3">
                <h5 class="col-lg-4 text-dark">Classic Level</h5>
                <h5 class="col-lg-4 text-dark">{{ $nurse->poients }} Point</h5>
            </div>
        </div>
        <div class="col-2">
            <a href="{{ route('nurse.edit.profile',$nurse->id) }}"><img src="{{url('imgs/edit.svg')}}" height="40" class="d-block w-100 mb-5" alt="..."></a>
    ...
    <div class="container row col-lg-6 ml-auto mr-auto text-center mt-5 mb-5">
            <div class="col-lg-3 ml-auto mr-auto" data-toggle="modal" data-target="#exampleModal">
                ...
                <h5 class="text-dark font-weight-bold text-center">Patient</h5>
            </div>
            <!-- Modal -->
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action = "{{ route('nurse_add_patient',$nurse->id) }}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                            {{ csrf_field() }}
        ...
        {{-- <div class="col-lg-3">
            ...
            <a href="{{ route('nurse.profile',$nurse->id) }}"><img src="{{url('imgs/Patirnt.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
            </div>
        ...
        <div class="col-lg-3 ">
            <div class="content-item ml-auto mr-auto">
            <a href="{{ route('nurse.qr.index',$nurse->id) }}"><img src="{{url('imgs/qrCode.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
            </div>
            <h5 class="text-dark font-weight-bold ml-auto mr-auto">QR Code</h5>
        </div>
        {{-- <div class="col-lg-3 ml-auto mr-auto">
            <div class="content-item ml-auto mr-auto">
              <a href="#"><img src="{{url('imgs/checklist.svg')}}" height="70" class="w-80 mt-3" alt="..."></a>
            </div>
            <h5 class="text-dark font-weight-bold ml-auto mr-auto">Orders</h5>
        </div> --}}
        <div class="col-lg-3">
            <div class="content-item ml-auto mr-auto">
              <a href="{{ route('nurse.club',$nurse->id) }}"><img src="{{url('imgs/logo.svg')}}" height="90" class="d-block w-100 mt-2" alt="..."></a>
            </div>
