                                ...
                                <!-- Card body -->
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('labs.patient.search',$labs->id)}}" method="GET">
                                            <div class="row m-1">
                                                <h5 class="col-8 mr-auto ml-auto font-weight-bold p-4">Enter Patient ID</h5>
                                                ...
                                                <div class="col-md-8 mr-auto ml-auto ui input mt-3 mb-3">
                                                    <button class="btn btn-primary col-md-12 h4"><i class="fa fa-search mr-2" aria-hidden="true"></i>Search</button>
                                                </div>


                                            </div>
                                        </form>
                                        <div class="col-md-8 text-center mb-5 ml-auto mr-auto">
                                            <button class="btn btn-success col-md-12 h4 " data-toggle="modal" data-target="#exampleModal">Add New patient</button>
                                        </div>
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                ...
                                                <div class="modal-body">
                                                    <form action = "{{ route('lab_add_patient',$labs->id) }}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                                        {{ csrf_field() }}
