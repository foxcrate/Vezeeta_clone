                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h6 font-weight-bold">Lab Name <i class="fa fa-star-of-life star"></i></label>
                                        <input onkeypress="return /[a-z ]/i.test(event.key)" value="{{old('labsName')}}" class="form-control @error('labsName') is-invalid @enderror" type="text" name="labsName" placeholder="Lab Name" style="text-transform:capitalize">
                                        @error('labsName')
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('Medical_License_Number')}}" class="form-control @error('Medical_License_Number') is-invalid @enderror" type="text" placeholder="Medical License Namber" name="Medical_License_Number">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h6 font-weight-bold">Lab License <i class="fa fa-star-of-life star"></i></label>
                                        <input value="{{old('labs_License')}}" class="form-control @error('labs_License') is-invalid @enderror" type="file" placeholder="" name="labs_License">
                                        @error('labs_License')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-xl-3">
                                    ...
                                    <label class="h6 ml-3 font-weight-bold">Add Xray</label>
                                </div> --}}
                                <div class="col-md-12 mb-xl-3">
                                    <hr class="my-4" />
                                    <div class="">
                                        <input type="checkbox" name="i_agree" id="i_agree">
                                        <label class="h6 font-weight-bold" style="font-size: .98rem;">I have read and I understand the  <a class="text-primary" href="{{route('getPrivacyRegister')}}">pHistroy privacy policy statement</a>, I agree on all terms and conditions.</a></label>
                                    </div>
                                </div>
