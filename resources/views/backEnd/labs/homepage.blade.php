...
<div class="bg-waves">
  ...
  <div class="container">
    <div class="row content-info col-lg-12 p-4 mt-5">
      <div class="col-2 mt-2">
        ...
        @else
            <img src="{{$labs->image}}" class="rounded-circle" width="120" height="120">
        @endif
      </div>
      <div class="col-8">
       <h4 class="mt-3 mb-3 font-weight-bold">{{$labs->labsName . ' labs'}}</h4>
       <h5 class="">{{$labs->idCode}}</h5>
       <div class="row mt-3">
         <h5 class="col-lg-4">Classic Level</h5>
         <h5 class="col-lg-4">{{ $labs->point }} Point</h5>
       </div>
      </div>
      <div class="col-2">
        <a href="{{route('labs.edit.profile',$labs->id)}}"><img src="{{url('imgs/edit.svg')}}" height="40" class="d-block w-100 mb-5" alt="..."></a>
  ...
  <div class="container row col-lg-6 ml-auto mr-auto text-center mt-5 mb-3">
    <div class="col-lg-3 ml-auto mr-auto">
        <div class="content-item ml-auto mr-auto">
          <a href="{{ route('labs.profile',$labs->id) }}"><img src="{{url('imgs/icon_png/patient.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
        </div>
      ...
      <div class="col-lg-3 ml-auto mr-auto">
        <div class="content-item ml-auto mr-auto">
          <a href="{{ route('lab.club',$labs->id) }}"><img src="{{url('imgs/logo.svg')}}" height="90" class="d-block w-100 mt-2" alt="..."></a>
        </div>
        <h5 class="text-dark font-weight-bold ml-auto mr-auto">Club</h5>
      </div>
      <div class="col-lg-3 ml-auto mr-auto">
        <div class="content-item ml-auto mr-auto">
          <a href="{{ route('lab.qr.index',$labs->id) }}"><img src="{{url('imgs/qrCode.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
        </div>
  ...
  <div class="container row col-lg-6 ml-auto mr-auto text-center mb-5">
    <div class="col-lg-3 ml-auto mr-auto">
      <div class="content-item ml-auto mr-auto">
        <a href="{{route('lab.mywork',$labs->id)}}"><img src="{{url('imgs/stethoscope.svg')}}" height="70" class="w-80 mt-3" alt="..."></a>
      </div>
    ...
    <div class="col-lg-3 ml-auto mr-auto">
        <div class="content-item ml-auto mr-auto">
          <a href="{{ route('lab.orders',$labs->id) }}"><img src="{{url('imgs/checklist.svg')}}" height="70" class="w-80 mt-3" alt="..."></a>
        </div>
        <h5 class="text-dark font-weight-bold ml-auto mr-auto">Orders</h5>
    </div>
    <div class="col-lg-3 ml-auto mr-auto">
      <div class="content-item ml-auto mr-auto">
        <a href="{{ route('labs.logout') }}"><img src="{{url('imgs/logout.png')}}" height="70" class="w-80 mt-3" alt="..."></a>
      </div>
