                ...
                <div class="container-fluid mt-5">
                    <ul class="nav nav-pills col-7 ml-auto mr-auto mt-5 mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link test_pres font-weight-bold active" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Rideology</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="header-body">
                                <div class="row pt-5 col-l2 ml-auto mr-auto">
                                    @if($patient_rays)
                                        @foreach(auth()->guard('patien')->user()->patient_rays as $patient_rays)
                                            <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                                                ...
                                                <div class="row col-12 mb-3">
                                                    ...
                                                    <div class="col-8">
                                                        @foreach ($patient_rays->ray_name as $ray_name)
                                                            <h5 class="">{{$ray_name['ray_name']}}</h5>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="row col-12 mb-3">
                                                    ...
                                                    <div class="col-8">
                                                        @foreach ($patient_rays->ray_name as $ray_name)
                                                            <h5 class="">{{$ray_name['ray_description']}}</h5>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="row col-12 mb-3">
