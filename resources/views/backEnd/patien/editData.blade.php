                    ...
                    <div class="row card p-5">
                        <div class="col-md-10 ml-auto mr-auto">
                            ...
                            <form enctype="multipart/form-data" role="form" action="{{route('update.data.profile',$patient->id)}}" method="POST" class="login-box">
                                ...
                                <input type="hidden" id="latitude" name="latitude" value="{{ $patient->latitude }}">
                                <input type="hidden" id="longitude" name="longitude" value="{{ $patient->longitude }}">
                                <input type="hidden" name="oldPhoneNumber" value="{{ $patient->phoneNumber }}">
                                {{--  <input type="hidden" name="role">  --}}
                                {{--  <input type="hidden" name="idCode" value="{{$patient->IdCode}}">
                                <input type="hidden" name="countryCode" value="{{$patient->countryCode}}">  --}}
                                <div class="row">
                                    <div class="container col-md-12 mb-5">
                                        <div class="avatar-wrapper">
                                            <img class="profile-pic" src="{{ $patient->image }}" />
                                    ...
                                    <div class="col-md-12 xl-3">
                                        <div class="form-group">
                                            ...
                                            <input value = "{{ str_replace($patient->countryCode,'',$patient->phoneNumber) }}" name="phoneNumber" type="text" placeholder="Phone Number" class="@error('phoneNumber') is-invalid @enderror form-control" style="padding-left: 280px">
                                    ...
                                    {{-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="address" type="text" class="form-control" value="{{ $patient->address }}" id="oldAddress">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-4">
                                        <div class="form-check">
                                            <input type="checkbox" id="disoldAddress" class="form-check-input">
                                            <label class="form-check-label" for="">Disapled</label>
                                        </div>
                                    </div> --}}
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="h5 font-weight-bold">Address</label>
                                            <input value="{{ $patient->address }}" type="text" id="pac-input"class="form-control" name="address">
