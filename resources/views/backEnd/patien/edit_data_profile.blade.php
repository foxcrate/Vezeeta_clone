...
<div class="d-flex bg-page" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="main-content" id="panel">
            <form action="{{route('updata_data_profile',[$patient->id,$patient->patinets_data->id])}}" method="POST"
                        ...
                        <div class="col-xl-4 order-xl-2">
                            <div class="card card-profile">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 order-lg-2">
                                        <div class="card-profile-image">
                                            <a href="#" class="">
                                                @if(!$patient->image)
                                                <a href="{{route('edit.data.profile',$patient->id)}}"><img
                                ...
                                <div class="card-body pt-0">
                                    <P class="h5 font-weight-bold text-center mt-5">
                                    ...
                                    <div class="pl-3 pr-3 mt-3">
                                        {{--  <h5 class="h5 mt-3 text-capitalize"><i class="fas fa-male mr-4 ml-1 text-primary"></i><span class="ml-3">{{$patient->gender}}</span>
                                        </h5> --}}
                                        {{--  <h5 class="h5 mt-3 text-capitalize"><i class="fa fa-calendar-check mr-3 text-primary" aria-hidden="true"></i><span class="ml-3">{{$patient->age}}
                                        Age</span></h5> --}}
                                        ...
                                        <h5 class="h5 mt-3 text-capitalize mb-5"><i
                                                class="fa fa-phone mr-3 text-primary" aria-hidden="true"></i><span
                                                class="ml-2">{{$patient->phoneNumber}}</span></h5>
                                    </div>
                                    <div class="text-center">
                                        <a href="{{route('edit.data.profile',$patient->id)}}"
                                            class="btn btn-primary col-5 h4">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input maxlength="3" class="form-control"
                                                                        ...
                                                                        value="{{$patient->patinets_data->height}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input minlength="2" maxlength="3" name="width"
                                                                        type="number" class="form-control"
                                                                        placeholder="Weight"
                                                                        value="{{$patient->patinets_data->width}}" />
                                                                    <select
                                                                        style="position:relative; bottom:38px; width:30%; left:210px;"
                                                                        name="width_type" id="" class="form-control">
                                                                        <optgroup>
                                                                            <option
                                                                                {{$patient->patinets_data->width_type == 'KG' ? 'selected' : ''}}
                                                                                value="Kg">KG</option>
                                                                            <option
                                                                                {{$patient->patinets_data->width_type == 'Lbs' ? 'selected' : ''}}
                                                                                value="Lbs">Lbs</option>
                                                                            <option
                                                                                {{$patient->patinets_data->width_type == 'St' ? 'selected' : ''}}
                                                                                value="St">ST</option>
                                                                        </optgroup>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div>
                                                                        <select class="form-control" name="blood">
                                                                            ...
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'A+' ? 'selected' : ''}}
                                                                                value="A+">A+</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'A-' ? 'selected' : ''}}
                                                                                value="A-">A-</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'B+' ? 'selected' : ''}}
                                                                                value="B+">B+</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'B-' ? 'selected' : ''}}
                                                                                value="B-">B-</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'o+' ? 'selected' : ''}}
                                                                                value="o+">O+</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'o-' ? 'selected' : ''}}
                                                                                value="o-">O-</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'AB+' ? 'selected' : ''}}
                                                                                value="AB+">AB+</option>
                                                                            <option
                                                                                {{$patient->patinets_data->blood == 'AB-' ? 'selected' : ''}}
                                                                                value="AB-">AB-</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="title-info">Check any Conditions you Currently Being
                                                        Treated for or have had in the past: </label>
                                                    <div class="form-flex">
                                                                ...
                                                                <div class="field">
                                                                    ...
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            ...
                                                                            value="Heart disease"
                                                                            {{is_array($agrees) && in_array('Heart disease',$agrees) ? 'checked' : ''}}>
                                                                ...
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            ...
                                                                            {{is_array($agrees) && in_array('High blood pressure',$agrees) ? 'checked' : ''}}>
                                                                        <label class="label-input">High blood pressure
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            ...
                                                                            {{is_array($agrees) && in_array('High cholesterol',$agrees) ? 'checked' : ''}}>
                                                                        <label class="label-input">High cholesterol
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Lung disease',$agrees) ? 'checked' : ''}}
                                                                            value="Lung disease">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Diabetes',$agrees) ? 'checked' : ''}}
                                                                            value="Diabetes">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Neck pain',$agrees) ? 'checked' : ''}}
                                                                            value="Neck pain">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Severe headaches',$agrees) ? 'checked' : ''}}
                                                                            value="Severe headaches">
                                                                        <label class="label-input">Severe headaches
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Back pain',$agrees) ? 'checked' : ''}}
                                                                            value="Back pain">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Seizures',$agrees) ? 'checked' : ''}}
                                                                            value="Seizures ">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Thyroid disease',$agrees) ? 'checked' : ''}}
                                                                            value="Thyroid disease">
                                                                        <label class="label-input">Thyroid disease
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Stroke Sleep apnea',$agrees) ? 'checked' : ''}}
                                                                            value="Stroke Sleep apnea">
                                                                        <label class="label-input">Stroke Sleep apnea
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Stomach disease',$agrees) ? 'checked' : ''}}
                                                                            value="Stomach disease">
                                                                        <label class="label-input">Stomach disease
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Kidney , bladder or prostate disease',$agrees) ? 'checked' : ''}}
                                                                            value="Kidney , bladder or prostate disease">
                                                                        <label class="label-input">Kidney , bladder or
                                                                            prostate disease </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- col -->
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Blood clots',$agrees) ? 'checked' : ''}}
                                                                            value="Blood clots">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Depression',$agrees) ? 'checked' : ''}}
                                                                            value="Depression">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Anemia or other blood disease',$agrees) ? 'checked' : ''}}
                                                                            value="Anemia or other blood disease">
                                                                        <label class="label-input">Anemia or other blood
                                                                            disease</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="field">
                                                                    <div class="ui checkbox">
                                                                        <input name="agree_name[]" type="checkbox"
                                                                            tabindex="0" class="hidden"
                                                                            {{is_array($agrees) && in_array('Cancer ( past or present )',$agrees) ? 'checked' : ''}}
                                                                            value="Cancer ( past or present )">
                                                                        <label class="label-input">Cancer ( past or
                                                                            present ) </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="title-info">Allergies (incloud medication, food and
                                                        ...
                                                        <li>
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <select name="allergi_data[{{$key}}][allergi_name]"
                                                                        class="add-allergy form-control item_typee">
                                                                        <option value="" hidden>Allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Drug" ? "selected" : ''}}
                                                                            value="Drug">Drug allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Food" ? "selected" : ''}}
                                                                            value="Food">Food allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Pet" ? "selected" : '' }}
                                                                            value="Pet">Pet allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Insect" ? "selected" : '' }}
                                                                            value="Insect">Insect allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Latex" ? "selected" : '' }}
                                                                            value="Latex">Latex allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Mold" ? "selected" : '' }}
                                                                            value="Mold">Mold allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Pollen" ? "selected" : ''}}
                                                                            value="Pollen">Pollen allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Dust" ? "selected" : '' }}
                                                                            value="Dust">Dust allergy</option>
                                                                        <option
                                                                            {{$array['allergi_name'] == "Other" ? "selected" : '' }}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <img src="{{url('imgs/dissection.png')}}" class="mr-3 mb-3"
                                                        width="50">
                                                        ...
                                                        <li>
                                                            <div class="row mb-3">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select name="surgery_data[{{$key}}][surgery_name]"
                                                                        class="add-surgery form-control item_surgeries">
                                                                        <option value="" hidden>Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Hernia" ? "selected" : ''}}
                                                                            value="Hernia">Hernia Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Hemorrhoid" ? "selected" : ''}}
                                                                            value="Hemorrhoid">Hemorrhoid Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Eye" ? "selected" : ''}}
                                                                            value="Eye">Eye surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Gallbladder" ? "selected" : ''}}
                                                                            value="Gallbladder">Gallbladder Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Appendix" ? "selected" : ''  }}
                                                                            value="Appendix">Appendix Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Cardiovascular" ? "selected" : ''}}
                                                                            value="Cardiovascular">Cardiovascular
                                                                            Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Tonsil" ? "selected" : ''}}
                                                                            value="Tonsil">Tonsil Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Liver" ? "selected" : ''}}
                                                                            value="Liver">Liver Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Cancer" ? "selected" : ''}}
                                                                            value="Cancer">Cancer and Oncology Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Kidney" ? "selected" : ''}}
                                                                            value="Kidney">Kidney Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Brain" ? "selected" : ''}}
                                                                            value="Brain">Brain Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Gastrointestinal" ? "selected" : ''}}
                                                                            value="Gastrointestinal">Gastrointestinal
                                                                            Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Reproductive" ? "selected" : ''}}
                                                                            value="Reproductive">Reproductive system
                                                                            Surgery</option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Nervous" ? "selected" : ''}}
                                                                            value="Nervous">Nervous system Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Respiratory" ? "selected" : ''}}
                                                                            value="Respiratory">Respiratory Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Orthopaedic" ? "selected" : ''}}
                                                                            value="Orthopaedic">Orthopaedic Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Ear" ? "selected" : ''}}
                                                                            value="Ear">Ear, nose and throat Surgery
                                                                        </option>
                                                                        <option
                                                                            {{$array_su['surgery_name'] == "Other" ? "selected" : ''}}
                                                                            value="Other">Other</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <label class="title-label">Date</label>
                                                                    <input value="{{$array_su['surgery_date']}}"
                                                                        class="add-surgery-date form-control seleect_surgeries"
                                                                        type="date"
                                                                        name="surgery_data[{{$key}}][surgery_date]"
                                                                        placeholder="">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label class="title-label ml-xl-3"></label>
                                                    ...
                                                    <ul class="list-unstyled read-more-wrap field_group2">
                                                        <li class="">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 mb-3">
                                                                    <select name="medication_name[{{$key}}][times_day]"
                                                                        class="medication-day col-12 custom-select required seleect_medication"
                                                                        id="inputGroupSelect01"
                                                                        value="{{$med['times_day']}}">
                                                                        <option value="" hidden>Times Day</option>
                                                                        <option value="1"
                                                                            {{$med['times_day'] == '1' ? 'selected' : ''}}>
                                                                            1</option>
                                                                        <option value="2"
                                                                            {{$med['times_day'] == '2' ? 'selected' : ''}}>
                                                                            2</option>
                                                                        <option value="3"
                                                                            {{$med['times_day'] == '3' ? 'selected' : ''}}>
                                                                            3</option>
                                                                        <option value="If necessity"
                                                                            {{$med['times_day'] == 'If necessity' ? 'selected' : ''}}>
                                                                            If necessity</option>
                                                                    </select>
                                                                </div>

                                                                <div class="col-md-3 mb-3">
                                                                    <select name="medication_name[{{$key}}][time]"
                                                                        ...
                                                                        <option value="Before Eating"
                                                                            {{$med['time'] == 'Before Eating' ? 'selected' : ''}}>
                                                                            Before Eating</option>
                                                                        <option value="After Eating"
                                                                            {{$med['time'] == 'After Eating' ? 'selected' : ''}}>
                                                                            After Eating</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label class="title-label ml-xl-3"></label>
                                                                    <button class="btn btn-danger h5" type="button"
                                            ...
                                            <div class="row col-md-12 mt-lg-3 mb-2">
                                                <div class="col-lg-12">
                                                    <img src="{{url('imgs/prescription.svg')}}" class="mr-3 mb-3"
                                                        width="50">
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="col-lg-12 title-info mb-auto">Adding
                                                            Prescription</label>
                                                        <input type="file" name="rocata_file[]" id="file"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="analzes_file[]" id="fileS"
                                                    ...
                                                    <div id="myRadioGroup">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <input class="ui radio checkbox" type="radio"
                                                                    name="colonscopy" value="2"
                                                                    {{$patient->patinets_data->colonscopy == 2 ? 'checked' : ''}} />
                                                                &nbsp; <label class="font-weight-600">No</label>
                                                            </div>
                                                            <div id="types1" class="desc col-8 ml-3 mb-3"
                                                                style="display: none;">
                                                                <input class="form-control" type="date"
                                                                    name="colonscopy_data"
                                                                    value="{{$patient->patinets_data->colonscopy_data}}">
                                                            </div>
                                                    ...
                                                    <div id="myRadioGroup">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <input class="ui radio checkbox" type="radio"
                                                                    name="mammogram"
                                                                    {{$patient->patinets_data->mammogram == 4 ? 'checked' : ''}}
                                                                    value="4" />&nbsp;&nbsp; <label
                                                                    class="font-weight-600">No</label>
                                                            </div>
                                                            <div id="type3" class="des col-8 ml-3 mb-3"
                                                                style="display: none;">
                                                                <input class="form-control" type="date"
                                                                    name="mammogram_data">
                                                            </div>
                                                        ...
                                                        <li class="">
                                                            <div class="row">
                                                                <div class="col-md-5 mb-3">
                                                                    ...
                                                                    <select name="smoking[{{ $key }}][name]"
                                                                        class="add-habit item_smoking form-control">
                                                                        <option value="" hidden>Name</option>
                                                                        <option
                                                                            {{$smoking_array['name'] == "alcohol" ? "selected" : ''}}
                                                                            value="alcohol">Alcohol</option>
                                                                        <option
                                                                            {{$smoking_array['name'] == "cigarette" ? "selected" : ''}}
                                                                            value="cigarette">Cigarette</option>
                                                                        <option
                                                                            {{$smoking_array['name'] == "drug" ? "selected" : ''}}
                                                                            value="drug">Drug</option>
                                                                    </select>
                                                                </div>

                                                                <div class="col-md-4 mb-3">
                                                                    <label class="title-label">Severity</label>
                                                                    <select name="smoking[{{ $key }}][severity]"
                                                                        class="add-habit-severity item_smoking_severity form-control">
                                                                        <option value="" hidden>Severity</option>
                                                                        <option
                                                                            {{$smoking_array['severity'] == "high" ? "selected" : ''}}
                                                                            value="high">High</option>
                                                                        <option
                                                                            {{$smoking_array['severity'] == "middle" ? "selected" : ''}}
                                                                            value="middle">Middle</option>
                                                                        <option
                                                                            {{$smoking_array['severity'] == "low" ? "selected" : ''}}
                                                                            value="low">Low</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label class="title-label ml-xl-3"></label>
                                                                    <button style="margin-top:37px"
                                                                        class="btn btn-danger h5" type="button"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="nav flex-row family-one nav-pills row ml-auto mr-auto decor-none justify-content-around"
                                                            ...
                                                            <a class="col-xl-3 col-md-2 col-4 nav-item nav-links active"
                                                                id="v-pills-5-tab" data-toggle="pill" href="#v-pills-5"
                                                                role="tab" aria-controls="v-pills-5"
                                                                aria-selected="true">
                                                                <div class="text-center">
                                                                    <img src="{{url('imgs/mother.png')}}" width="100">
                                                                    <h4 class="text-pills m-auto"
                                                                        style="font-size:12pt;padding-top:15px;">Mother
                                                                    </h4>
                                                                </div>
                                                            </a>
                                                            <a class="col-xl-3 col-md-2 col-4 nav-item nav-links"
                                                                id="v-pills-6-tab" data-toggle="pill" href="#v-pills-6"
                                                                role="tab" aria-controls="v-pills-6"
                                                                aria-selected="true">
                                                                <div class="text-center">
                                                                    <img src="{{url('imgs/father.png')}}" width="100">
                                                                    <h4 class="text-pills m-auto"
                                                                        style="font-size: 12pt;padding-top:15px;">Father
                                                                    </h4>
                                                                </div>
                                                            </a>
                                                                                ...
                                                                                <div class="inline field">
                                                                                    ...
                                                                                    <select name="mother[]"
                                                                                        ...
                                                                                        <option value="cancer">Cancer
                                                                                            (Past or Present)</option>
                                                                                        <option value="None">None
                                                                                        </option>
                                                                                        @if($patient->patinets_data->mother)
                                                                                        @foreach($patient->patinets_data->mother
                                                                                        as $mother)
                                                                                        <option value="{{$mother}}"
                                                                                            selected>
                                                                                            {{$mother}}
                                                                            ...
                                                                            <div class="ui form col-12">
                                                                                <div class="inline field">
                                                                                    ...
                                                                                    <select name="father[]"
                                                                                        ...
                                                                                        @foreach($patient->patinets_data->father
                                                                                        as $father)
                                                                                        <option value="{{$father}}"
                                                                                            selected>
                                                                                            {{$father}}
                                            ...
                                            <div class="col-12">
                                                <!-- female -->
                                                @if(auth()->guard('patien')->user()->gender == 'female' &&
                                                ...
                                                <div class="row tab-Female col-10 mr-auto ml-auto mb-3 mt-3">
                                                    <div class="p-3 col-xl-9 mb-2 mt-3 mr-auto ml-auto">
                                                        ...
                                                        <input class="ui radio checkbox col-1" type="radio"
                                                            ...
                                                            class="font-weight-600">Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input class="ui radio checkbox col-1 ml-4" type="radio"
                                                            name="single_Period_Cycle" value="No" /> <label
                                                            class="font-weight-600">No</label>
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                <div class="col-12 ml-auto mr-auto">
                                                    <div class="nav flex-row nav-pills female row offset-xl-1 col-12"
                                                        id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                                                        <a class="col-md-4 p-2 mr-1 active" id="v-pills-01-tab"
                                                            data-toggle="pill" href="#v-pills-01" role="tab"
                                                            aria-controls="v-pills-01" aria-selected="true">
                                                            <div class="text-center">
                                                                <div><img src="{{url('imgs/mother.png')}}" width="120">
                                                                </div>
                                                                <div>
                                                        ...
                                                        <a class="col-md-4 p-2 mr-1" id="v-pills-02-tab"
                                                            data-toggle="pill" href="#v-pills-02" role="tab"
                                                            aria-controls="v-pills-02" aria-selected="true">
                                                            <div class="text-center">
                                                                <div><img src="{{url('imgs/femalmother.png')}}"
                                                                        width="120"></div>
                                                                <div>
                                                        ...
                                                        <div class="tab-content mr-auto ml-auto"
                                                            ...
                                                            <div class="tab-pane animated bounce slow py-0 show active"
                                                                ...
                                                                <div class="row mb-3 mt-3">
                                                                    <div class="col-xl-9 mb-3 mr-auto ml-auto">
                                                                        <label class="mr-7 col-6 title-label">Have you a
                                                                            Normal Period Cycle </label>
                                                                        <input class="ui radio checkbox col-1"
                                                                            type="radio" name="Period_Cycle"
                                                                            {{$patient->patinets_data->Period_Cycle == 'Yes' ? 'checked' : ''}}
                                                                            value="Yes" /><label
                                                                            class="font-weight-600">Yes</label>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input class="ui radio checkbox col-1 ml-4"
                                                                            type="radio" name="Period_Cycle"
                                                                            {{$patient->patinets_data->Period_Cycle == 'No' ? 'checked' : ''}}
                                                                            value="No" /> <label
                                                                            class="font-weight-600">No</label>
                                                                    </div>
                                                                    <div class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                        ...
                                                                        <input class="ui radio checkbox col-1"
                                                                            ...
                                                                            {{$patient->patinets_data->Abotion == 'yes' ? 'checked' : ''}}
                                                                            value="yes" /><label
                                                                            class="font-weight-600">Yes</label>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input class="ui radio checkbox col-1 ml-4"
                                                                            type="radio" name="Abotion"
                                                                            {{$patient->patinets_data->Abotion == 'no' ? 'checked' : ''}}
                                                                            value="no" /><label
                                                                            class="font-weight-600">No</label>
                                                                    </div>
                                                                    <div
                                                                        class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto ">
                                                                        <label
                                                                        ...
                                                                        <select name="Contraceptive"
                                                                            ...
                                                                            <option
                                                                                {{$patient->patinets_data->Contraceptive == 'Pill' ? 'selected' : ''}}
                                                                                value="Pill">Pill</option>
                                                                            <option
                                                                                {{$patient->patinets_data->Contraceptive == 'Implant' ? 'selected' : ''}}
                                                                                value="Implant">Implant</option>
                                                                            <option
                                                                                {{$patient->patinets_data->Contraceptive == 'Intrauterine' ? 'selected' : ''}}
                                                                                value="Intrauterine">Intrauterine Device
                                                                            </option>
                                                                            <option
                                                                                {{$patient->patinets_data->Contraceptive == 'Injection' ? 'selected' : ''}}
                                                            ...
                                                            <div class="tab-pane animated bounce slow py-0 show"
                                                                ...
                                                                <div class="row mb-3 mt-3">
                                                                    ...
                                                                    <div class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                        ...
                                                                        <input class="ui radio checkbox col-1"
                                                                            type="radio" name="pregnency"
                                                                            {{$patient->patinets_data->pregnency == 'yes' ? 'checked' : ''}}
                                                                            value="yes" /><label
                                                                            class="font-weight-600">Yes</label>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input class="ui radio checkbox col-1 ml-4"
                                                                            type="radio" name="pregnency"
                                                                            {{$patient->patinets_data->pregnency == 'no' ? 'checked' : ''}}
                                                                            value="no" /><label
                                                                            class="font-weight-600">No</label>
                                                                    </div>
                                                                    <div class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                    ...
                                                                    <div class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                        <label class="mr-7 col-6 title-label">Types of
                                                                            Deliveries </label>
                                                                        <input class="ui radio checkbox col-1"
                                                                            type="radio" name="deliveries"
                                                                            {{$patient->patinets_data->deliveries == 'normal' ? 'checked' : ''}}
                                                                            value="normal" /><label
                                                                            class="font-weight-600">Normal</label>
                                                                        <input class="ui radio checkbox col-1 ml-3"
                                                                            type="radio" name="deliveries"
                                                                            {{$patient->patinets_data->deliveries == 'c.s' ? 'checked' : ''}}
                                                                            value="c.s" /><label
                                                                    ...
                                                                    <div class="col-xl-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                        <label
                                                                            ...
                                                                            in Deliveries </label>
                                                                        <input class="ui radio checkbox col-1"
                                                                            type="radio" name="complicetion"
                                                                            {{$patient->patinets_data->complicetion == 'yes' ? 'checked' : ''}}
                                                                            value="yes" /><label
                                                                            class="font-weight-600">Yes</label>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input class="ui radio checkbox col-1 ml-4"
                                                                            type="radio" name="complicetion"
                                                                            {{$patient->patinets_data->complicetion == 'no' ? 'checked' : ''}}
                                                                            value="no" /><label
                                                                            class="font-weight-600">No</label>
                                                                    </div>
                                                                    <div
