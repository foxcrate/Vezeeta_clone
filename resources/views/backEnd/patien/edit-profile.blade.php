                                                ...
                                                <div class="form-group">
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            ...
                                                            @if( $patient->email == null && $patient->job == null && $patient->race == null && $patient->state == null && $patient->address == null )
                                                                <div class="row mb-3">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select value = "{{old('nationality')}}" class="form-control  @error('nationality') is-invalid @enderror"  id="nationality" name="nationality" >
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select  class="form-control" id = "race" name = "race" @error('race') is-invalid @enderror>
                                                                                {{-- <option hidden>Choose ..</option> --}}
                                                        ...
                                                        <ul class="list-unstyled read-more-wrap ml-auto mr-auto field_groupUn">
                                                            <li>
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <label class="title-label ml-xl-3"></label>
                                                                        <button  class = "btn btn-danger h5" style="margin-top:37px" type="reset" id="remove_more_smoking">Delete</button>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </ul>
