                                ...
                                <div id="personalData">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="pl-3 pr-3 mt-3">
                                                    ...
                                                    <div class="row h5 mt-3">
                                                        <i class="fa fa-calendar-check mr-3 text-primary"
                                                            aria-hidden="true"></i>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h3 class="title-sub text-uppercase text-muted mb-4">User information
                                                </h3>
                                                        ...
                                                        <div class="form-group">
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    ...
                                                                    @if( $patient->email == null && $patient->job ==
                                                                    null &&
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select value="{{old('nationality')}}"
                                                                                    ...
                                                                                    <option data-countryCode="SK"
                                                                                        value="Slovak Republic">Slovak
                                                                                        Republic</option>
                                                                                    <option data-countryCode="SI"
                                                                                        value="Slovenia">
                                                                                        Slovenia</option>
                                                                                    <option data-countryCode="SB"
                                                                                        value="Solomon Islands">Solomon
                                                                                        Islands</option>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select id="job" name="job"
                                                                                    ...
                                                                                    <option value="Decoration designer">
                                                                                        Decoration
                                                                                        Designer</option>
                                                                                    ...
                                                                                    <option value="Work man">Work Man
                                                                                    </option>
                                                                                    ...
                                                                                    <option value="Barber">Barber
                                                                                    </option>
                                                                                    <option value="Dressmaker">
                                                                                        Dressmaker</option>
                                                                                    <option value="Painter">Painter
                                                                                    </option>
                                                                                    <option value="Herdsman">Herdsman
                                                                                    </option>
                                                                                    <option value="Driver">Driver
                                                                                    </option>
                                                                                    <option value="Barber">Barber
                                                                                    </option>
                                                                                    <option value="Office boy">Office
                                                                                        Boy</option>
                                                                                    ...
                                                                                    <option value="Fisher man">Fisher
                                                                                        Man</option>
                                                                                    <option value="Clean Worker">Clean
                                                                                        Worker</option>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-control" id="race"
                                                                                    name="race" @error('race')
                                                                                    is-invalid @enderror>
                                                                                    {{-- <option hidden>Choose ..</option> --}}
                                                                                    <option value="">Race</option>
                                                                                    <option value="Arabian Gulf">Arabian
                                                                                        Gulf</option>
                                                                                    <option value="African">African
                                                                                    </option>
                                                                                    <option value="Middle East">Middle
                                                                                        East</option>
                                                                                    <option value="Black American">Black
                                                                                        American
                                                                                    </option>
                            ...
                            <div class="carousel-item">
                                <div id="medicalData">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <h3 class="title-sub text-uppercase text-muted mb-4">Patient History
                                                </h3>
                                                <div class="pl-lg-4">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <img src="{{url('imgs/01.png')}}" class="mr-3 mb-3"
                                                                    width="50">
                                                                <label class="title-info">Check any Conditions you
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Severe
                                                                                        headaches </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    <input name="agree_name[]"
                                                                                        ...
                                                                                        class="hidden"
                                                                                        value="Seizures ">
                                                                                    <label class="label-input">Seizures
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Thyroid
                                                                                        disease </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Stroke
                                                                                        Sleep apnea </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Stomach
                                                                                        disease </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Kidney ,
                                                                                        bladder or prostate
                                                                                        disease </label>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Anemia or
                                                                                        other blood
                                                                                        disease</label>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="field">
                                                                                <div class="ui checkbox">
                                                                                    ...
                                                                                    <label class="label-input">Cancer (
                                                                                        past or present )
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <img src="{{url('imgs/033.png')}}" class="mr-3 mb-3"
                                                                    width="50">
                                                                <label class="title-info">Allergies (incloud medication,
                                                                    food and
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="" hidden>Allergy
                                                                                    </option>
                                                                                    <option value="Drug">Drug allergy
                                                                                    </option>
                                                                                    <option value="Food">Food allergy
                                                                                    </option>
                                                                                    <option value="Pet">Pet allergy
                                                                                    </option>
                                                                                    <option value="Insect">Insect
                                                                                        allergy</option>
                                                                                    <option value="Latex">Latex allergy
                                                                                    </option>
                                                                                    <option value="Mold">Mold allergy
                                                                                    </option>
                                                                                    <option value="Pollen">Pollen
                                                                                        allergy</option>
                                                                                    <option value="Dust">Dust allergy
                                                                                    </option>
                                                                                    <option value="Other">Other</option>
                                                                                </select>
                                                                                @error('allergi_data')
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    class="form-control seelect_custom"
                                                                                    type="text"
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <button class="btn btn-danger h5"
                                                                                    style="margin-top:37px" type="reset"
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="" hidden>Surgery
                                                                                    </option>
                                                                                    <option value="Hernia">Hernia
                                                                                        Surgery</option>
                                                                                    <option value="Hemorrhoid">
                                                                                        Hemorrhoid Surgery</option>
                                                                                    <option value="Eye">Eye surgery
                                                                                    </option>
                                                                                    <option value="Gallbladder">
                                                                                        Gallbladder Surgery</option>
                                                                                    <option value="Appendix">Appendix
                                                                                        Surgery</option>
                                                                                    <option value="Cardiovascular">
                                                                                        Cardiovascular Surgery
                                                                                    </option>
                                                                                    <option value="Tonsil">Tonsil
                                                                                        Surgery</option>
                                                                                    <option value="Liver">Liver Surgery
                                                                                    </option>
                                                                                    <option value="Cancer">Cancer and
                                                                                        Oncology Surgery
                                                                                    </option>
                                                                                    <option value="Kidney">Kidney
                                                                                        Surgery</option>
                                                                                    <option value="Brain">Brain Surgery
                                                                                    </option>
                                                                                    ...
                                                                                    <option value="Nervous">Nervous
                                                                                        system Surgery</option>
                                                                                    <option value="Respiratory">
                                                                                        Respiratory Surgery</option>
                                                                                    <option value="Muscle">Muscle system
                                                                                        Surgery</option>
                                                                                    <option value="Orthopaedic">
                                                                                        Orthopaedic Surgery</option>
                                                                                    <option value="Ear">Ear, nose and
                                                                                        throat Surgery
                                                                                    </option>
                                                                                    <option value="Other">Other</option>
                                                                                </select>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input
                                                                                    class="form-control seleect_surgeries"
                                                                                    type="date"
                                                                    ...
                                                                    <li class="">
                                                                        <div class="row">
                                                                            <div class="col-md-3 mb-3">
                                                                                <input list="brow"
                                                                                    class="form-control item_medication"
                                                                            ...
                                                                            <div class="col-md-3 mb-3">
                                                                                <select name="medication_name[0][time]"
                                                                                    ...
                                                                                    <option value="Before Eating">Before
                                                                                        Eating</option>
                                                                                    <option value="After Eating">After
                                                                                        Eating</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <select name="smoking[0][name]"
                                                                                    ...
                                                                                    <option value="cigarette">Cigarette
                                                                                    </option>
                                                        ...
                                                        <div class="col-12 mt-5">
                                                            <!-- Family History -->
                                                            <h3 class="title-sub text-uppercase text-muted mb-4">Family
                                                                History</h3>
                                                            <div class="pl-lg-4">
                                                                <h4
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <h4 class="text-pink ml-5 mt-3 mb-4 font-weight-bold">Female
                                                                Single</h4>
                                                            <div
                                                                class="row tab-Female col-10 mr-auto ml-auto mb-3 mt-3">
                                                                <div class="p-3 col-lg-9 mb-2 mt-3 mr-auto ml-auto">
                                                                    <label class="mr-7 col-lg-6 title-label">Have you a
                                                                        Normal Period Cycle
                                                                    </label>
                                                            ...
                                                            <div class="col-12 ml-auto mr-auto">
                                                                <div class="nav flex-row nav-pills female row offset-lg-1 col-12"
                                                                    ...
                                                                    <a class="col-md-4 p-2 mr-1 active"
                                                                        ...
                                                                        <div class="text-center">
                                                                            <div><img src="{{url('imgs/mother.png')}}"
                                                                                    width="120"></div>
                                                                            <div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="tab-content mr-auto ml-auto"
                                                                        ...
                                                                        <div class="tab-pane animated bounce slow py-0 show active"
                                                                            ...
                                                                            <h5 class="text-pink ml-5 mt-3">Female Wife
                                                                            </h5>
                                                                        ...
                                                                        <div class="tab-pane animated bounce slow py-0 show"
                                                                            ...
                                                                            <h5 class="text-pink ml-5 mt-3">Female
                                                                                Mother</h5>
                                                                            <div class="row mb-3 mt-3">
                                                                                <div
                                                                                    class="col-lg-9 mb-3 mr-auto ml-auto">
