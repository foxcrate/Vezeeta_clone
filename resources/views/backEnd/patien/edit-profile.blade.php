...
<div class="d-flex bg-page" id="wrapper">
                                                    ...
                                                    <div class="form-group">
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                ...
                                                                @if( $patient->email == null && $patient->job == null &&
                                                                $patient->race == null && $patient->state == null &&
                                                                $patient->address == null )
                                                                <div class="row mb-3">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            {{-- <img src="{{url('imgs/height.png')}}" class="mr-3
                                                                            mb-3" width="50"> --}}
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select value="{{old('nationality')}}"
                                                                                ...
                                                                                <option data-countryCode="AI" value="Anguilla">
                                                                                    Anguilla</option>
                                                                                <option data-countryCode="AG" value="Antigua">
                                                                                ...
                                                                                <option data-countryCode="SM" value="San Marino">San
                                                                                    Marino</option>
                                                                                <option data-countryCode="ST" value="Sao Tome">Sao
                                                                                ...
                                                                                <option data-countryCode="TT" value="Trinidad">
                                                                                ...
                                                                                <option data-countryCode="TM" value="Turkmenistan">
                                                                                    Turkmenistan</option>
                                                                                <option data-countryCode="TC" value="Turks">Turks
                                                                                ...
                                                                                <option data-countryCode="UY" value="Uruguay">
                                                                                    Uruguay </option>
                                                                                <option data-countryCode="US" value="USA">USA
                                                                                </option>
                                                                                ...
                                                                                <option data-countryCode="VI"
                                                                                    value="Virgin Islands - US">Virgin Islands - US
                                                                                </option>
                                                                                <option data-countryCode="WF" value="Wallis">Wallis
                                                                                    &amp; Futuna </option>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="job" class="title-label ml-lg-3">Job
                                                                                Title</label>
                                                                            <select id="job" name="job" class="form-control">
                                                                                ...
                                                                                <option value="Industrial Engineer">Industrial
                                                                                    Engineer</option>
                                                                                <option value="software engineer">Software Engineer
                                                                                </option>
                                                                                <option value="Structural Engineer">Structural
                                                                                    Engineer</option>
                                                                                <option value="Architect">Architect</option>
                                                                                <option value="computer engineer">Computer Engineer
                                                                                </option>
                                                                                <option value="Electrical Engineer">Electrical
                                                                                    Engineer</option>
                                                                                <option value="flight engineer">Flight Engineer
                                                                                </option>
                                                                                <option value="Decoration designer">Decoration
                                                                                    Designer</option>
                                                                                ...
                                                                                <option value="Construction Worker">Construction
                                                                                    Worker</option>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control" id="race" name="race"
                                                                                @error('race') is-invalid @enderror>
                                                                                {{-- <option hidden>Choose ..</option> --}}
                                                                                <option value="">Race</option>
                                                                                <option value="Arabian Gulf">Arabian Gulf</option>
                                                                                <option value="African">African</option>
                                                                                <option value="Middle East">Middle East</option>
                                                                                <option value="Black American">Black American
                                                                                </option>
                                                                                <option value="Asian">Asian</option>
                                                                                <option value="White">White</option>
                                                                                <option value="Hawalian Or other Pacific Islander">
                                                                                    Hawalian Or other Pacific Islander</option>
                                                                                <option value="American India/Alaska Native">
                                                                                    American India/Alaska Native</option>
                                                                            </select>
                                                                            @error('race')
                                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                                            @enderror
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <div class="form-flex row">
                                                                            <div class="col-3 mr-4">
                                                                                <input type="radio" name="state" value="single"
                                                                                    id="single" checked="checked" />
                                                                                <label for="single" class="ml-2">Single</label>
                                                                            </div>
                                                                            <div class="col-3 mr-4">
                                                                                <input type="radio" name="state" value="married"
                                                                                    id="married" />
                                                                                <label for="married" class="ml-2">Married</label>
                                                                            </div>
                                                                            <div class="col-3 mr-4">
                                                                                <input type="radio" name="state" value="divorce"
                                                                                    id="divorce" />
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <img src="{{url('imgs/height.png')}}" class="mr-3 mb-3"
                                                                                width="50">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <img src="{{url('imgs/Wight.png')}}" class="mr-3 mb-3"
                                                                                width="50">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <img src="{{url('imgs/blood.png')}}" class="mr-3 mb-3"
                                                                                width="50">
                            ...
                            <div id="medicalData">
                                <div class="col-lg-4">
                                    <div class="card card-profile">
                                        ...
                                        <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                                            <div class="d-flex justify-content-between">
                                                {{--  <a href="{{route('edit.data.profile',$patient->id)}}" class="float-lg-left"><i
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="title-info">Check any Conditions you Currently Being Treated
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Heart disease">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="High blood pressure">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="High cholesterol">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Lung disease">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Severe headaches">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Thyroid disease">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Stroke Sleep apnea">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Stomach disease">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                ...
                                                                                <label class="label-input">Kidney , bladder or prostate
                                                                                    disease </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Blood clots">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="field">
                                                                            <div class="ui checkbox">
                                                                                <input name="agree_name[]" type="checkbox" tabindex="0"
                                                                                    class="hidden" value="Cancer ( past or present )">
                                                                                <label class="label-input">Cancer ( past or present )
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <li>
                                                                    <div class="row mb-3">
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <select name="allergi_data[0][allergi_name]"
                                                                                class=" @error('allergi_data') is-invalid @enderror form-control item_typee">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <select name="allergi_data[0][severity]"
                                                                                class="form-control seleect_custom">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <input onkeypress="return /[a-z]/i.test(event.key)"
                                                                                class="form-control seelect_custom" type="text"
                                                                                name="allergi_data[0][reaction]" placeholder="Reaction">
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <label class="title-label ml-xl-3"></label>
                                                                            <button class="btn btn-danger h5" style="margin-top:37px"
                                                                                type="reset" id="remove_more_fields">Delete</button>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            <button class="btn btn-success col-3 h5" type="button" id="more_fields">Add
                                                                New Allergy</button>
                                                        </div>
                                                        <hr />
                                                    </div>
                                                                ...
                                                                <li>
                                                                    <div class="row mb-3">
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <select name="surgery_data[0][surgery_name]"
                                                                                class="@error('surgery_data') is-invalid @enderror form-control item_surgeries">
                                                                                ...
                                                                                <option value="Cardiovascular">Cardiovascular Surgery
                                                                                </option>
                                                                                <option value="Tonsil">Tonsil Surgery</option>
                                                                                <option value="Liver">Liver Surgery</option>
                                                                                <option value="Cancer">Cancer and Oncology Surgery
                                                                                </option>
                                                                                <option value="Kidney">Kidney Surgery</option>
                                                                                <option value="Brain">Brain Surgery</option>
                                                                                <option value="Gastrointestinal">Gastrointestinal
                                                                                    Surgery</option>
                                                                                <option value="Reproductive">Reproductive system Surgery
                                                                                </option>
                                                                                ...
                                                                                <option value="Ear">Ear, nose and throat Surgery
                                                                                </option>
                                                                                <option value="Other">Other</option>
                                                                            </select>
                                                                            @error('surgery_data')
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <input class="form-control seleect_surgeries" type="date"
                                                                                name="surgery_data[0][surgery_date]" placeholder="">

                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label class="title-label ml-xl-3"></label>
                                                                            <button class="btn btn-danger h5" style="margin-top:37px"
                                                                                type="reset" id="remove_more_surgeries">Delete</button>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            <button class="btn btn-success col-3 h5" type="button"
                                                                id="more_surgeries">Add New Surgery</button>
                                                        </div>
                                                        <hr />
                                                    </div>
                                                    <hr class="my-4" />
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                                ...
                                                                <li class="">
                                                                    <div class="row">
                                                                        <div class="col-md-3 mb-3">
                                                                            <input list="brow" class="form-control item_medication"
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            <select name="medication_name[0][times_day]"
                                                                                class="@error('medication_name') is-invalid @enderror col-12 custom-select required seleect_medication"
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            <select name="medication_name[0][time]"
                                                                                class="col-12 custom-select required select_medication"
                                                                                id="inputGroupSelect01">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label class="title-label ml-xl-3"></label>
                                                                            <button class="btn btn-danger h5" type="reset"
                                                            ...
                                                            <button class="btn btn-success col-3 h5" type="button"
                                                                id="more_medication">Add New Medication</button>
                                                        </div>
                                                        <hr />
                                                    </div>
                                                            ...
                                                            <div id="myRadioGroup">
                                                                <div class="row">
                                                                    <label class="col-5 ml-4 mb-3 title-label">Have you had a
                                                                        colonscopy</label>
                                                                    <div class="col-4">
                                                                        <input class="ui radio checkbox" type="radio" name="colonscopy"
                                                                            value="1" />&nbsp; <label
                                                            ...
                                                            <div id="myRadioGroup">
                                                                <div class="row">
                                                                    <label class="h5 col-5 ml-4 mb-3 title-label">Have you had a
                                                                        Mammogram</label>
                                                                    <div class="col-4">
                                                                        <input class="ui radio checkbox" type="radio" name="mammogram"
                                                                            value="3" />&nbsp; <label
                                                                            class="font-weight-600">Yes</label> &nbsp;&nbsp;
                                                                        <input class="ui radio checkbox" type="radio" name="mammogram"
                                                                            value="4" />&nbsp;&nbsp; <label
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <select name="smoking[0][name]"
                                                                                class="item_smoking form-control">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <select name="smoking[0][severity]"
                                                                                class="item_smoking_severity form-control">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <label class="title-label ml-xl-3"></label>
                                                                            <button class="btn btn-danger h5" style="margin-top:37px"
                                                                                type="reset" id="remove_more_smoking">Delete</button>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            <button class="btn btn-success col-3 h5" type="button" id="more_smoking">Add
                                                    ...
                                                    <div class="col-12 mt-5">
                                                        ...
                                                        <div class="pl-lg-4">
                                                            <h4 class="text-primary ml-5 mt-3 mb-5 font-weight-bold">Family Diseases
                                                            </h4>
                                                            <div class="col-12">
                                                                <div class="nav flex-row family-one nav-pills row ml-auto mr-auto decor-none"
                                                                    ...
                                                                    <a class="col-lg-3 col-md-2 col-4 nav-item nav-links active"
                                                                        ...
                                                                        <div class="text-center">
                                                                            ...
                                                                            <h4 class="text-pills m-auto"
                                                                                style="font-size:12pt;padding-top:15px;">Mother</h4>
                                                                        </div>
                                                                    </a>
                                                                    <a class="col-lg-3 col-md-2 col-4 nav-item nav-links"
                                                                        ...
                                                                        <div class="text-center">
                                                                            ...
                                                                            <h4 class="text-pills m-auto"
                                                                                style="font-size: 12pt;padding-top:15px;">Father</h4>
                                                                        </div>
                                                                    </a>
                                                                                    ...
                                                                                    <div class="ui form col-12">
                                                                                        <div class="inline field">
                                                                                            <label class="h6 font-weight-bold"
                                                                                                ...
                                                                                                Diseases</label>
                                                                                            <select name="mother[]" multiple="multiple"
                                                                                                class="label ui large selection fluid dropdown">
                                                                                                <option value="high-Blood-Pressure">High
                                                                                                    Blood Pressure</option>
                                                                                                <option value="diabetes">Diabetes
                                                                                                </option>
                                                                                                <option value="cancer">Cancer (Past or
                                                                                                    Present)</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="ui form col-12">
                                                                                        <div class="inline field">
                                                                                            <label class="h6 font-weight-bold"
                                                                                                ...
                                                                                                Diseases</label>
                                                                                            <select name="father[]" multiple="multiple"
                                                                                                class="label ui large selection fluid dropdown">
                                                                                                <option value="high-Blood-Pressure">High
                                                                                                    Blood Pressure</option>
                                                                                                <option value="diabetes">Diabetes
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="row tab-Female col-10 mr-auto ml-auto mb-3 mt-3">
                                                            <div class="p-3 col-lg-9 mb-2 mt-3 mr-auto ml-auto">
                                                                <label class="mr-7 col-lg-6 title-label">Have you a Normal Period Cycle
                                                                </label>
                                                        ...
                                                        <div class="col-12 ml-auto mr-auto">
                                                            <div class="nav flex-row nav-pills female row offset-lg-1 col-12"
                                                                ...
                                                                <a class="col-md-4 p-2 mr-1" id="v-pills-02-tab" data-toggle="pill"
                                                                    href="#v-pills-02" role="tab" aria-controls="v-pills-02"
                                                                    aria-selected="true">
                                                                    <div class="text-center">
                                                                        <div><img src="{{url('imgs/femalmother.png')}}" width="120">
                                                                        </div>
                                                                        <div>
                                                                ...
                                                                <div class="tab-content mr-auto ml-auto" id="v-pills-tabContent">
                                                                    <div class="tab-pane animated bounce slow py-0 show active"
                                                                        ...
                                                                        <div class="row mb-3 mt-3">
                                                                            <div class="col-lg-9 mb-3 mr-auto ml-auto">
                                                                                <label class="mr-7 col-6 title-label">Have you a Normal
                                                                                    Period Cycle </label>
                                                                                <input class="ui radio checkbox col-1" type="radio"
                                                                                    name="Period_Cycle" value="Yes" /><label
                                                                                    class="font-weight-600">Yes</label>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <input class="ui radio checkbox col-1 ml-4" type="radio"
                                                                                    name="Period_Cycle" value="No" /> <label
                                                                                    class="font-weight-600">No</label>
                                                                            </div>
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                                <label class="mr-7 col-6 title-label">Abotion</label>
                                                                                <input class="ui radio checkbox col-1" type="radio"
                                                                                    name="Abotion" value="yes" /><label
                                                                                    class="font-weight-600">Yes</label>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <input class="ui radio checkbox col-1 ml-4" type="radio"
                                                                                    name="Abotion" value="no" /><label
                                                                                    class="font-weight-600">No</label>
                                                                            </div>
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto ">
                                                                                ...
                                                                                <select name="Contraceptive"
                                                                                    ...
                                                                                    <option value="Intrauterine">Intrauterine Device
                                                                                    </option>
                                                                    ...
                                                                    <!-- female mother -->
                                                                    <div class="tab-pane animated bounce slow py-0 show" id="v-pills-02"
                                                                        role="tabpanel" aria-labelledby="v-pills-02-tab">
                                                                        ...
                                                                        <div class="row mb-3 mt-3">
                                                                            ...
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                                ...
                                                                                <input class="ui radio checkbox col-1" type="radio"
                                                                                    name="pregnency" value="yes" /><label
                                                                                    class="font-weight-600">Yes</label>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <input class="ui radio checkbox col-1 ml-4" type="radio"
                                                                                    name="pregnency" value="no" /><label
                                                                                    class="font-weight-600">No</label>
                                                                            </div>
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                                <label class="mr-7 col-6 title-label">Abotion</label>
                                                                            ...
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                                <label class="mr-7 col-6 title-label">Types of
                                                                                    Deliveries </label>
                                                                                <input class="ui radio checkbox col-1" type="radio"
                                                                                    name="deliveries" value="normal" /><label
                                                                                    class="font-weight-600">Normal</label>
                                                                                <input class="ui radio checkbox col-1 ml-3" type="radio"
                                                                                    name="deliveries" value="c.s" /><label
                                                                                    class="font-weight-600">C.S</label>
                                                                            </div>
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto">
                                                                                <label class="mr-7 col-6 title-label">Complicetion in
                                                                                    Deliveries </label>
                                                                                <input class="ui radio checkbox col-1" type="radio"
                                                                                    name="complicetion" value="yes" /><label
                                                                                    class="font-weight-600">Yes</label>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <input class="ui radio checkbox col-1 ml-4" type="radio"
                                                                                    name="complicetion" value="no" /><label
                                                                                    class="font-weight-600">No</label>
                                                                            </div>
                                                                            <div class="col-lg-9 col-md-4 mb-3 mr-auto ml-auto ">
                                                                                <label class="title-label col-6">Contraceptive</label>
    ...
    <script>
        ...
        $('#more_surgeries').click(function () {
            ...
            if (current1 < max) {
                $('.field_group1:first').clone(true).hide().insertAfter('.field_group1:last').slideDown(
                    'slow');
                ...
                last.find('select.item_surgeries').attr("name", "surgery_data[" + current +
                    "][surgery_name]");
                last.find('input.seleect_surgeries').attr("name", "surgery_data[" + current +
                    "][surgery_date]").val('');
                current1++;
                return false;
            }
        ...
        $('#more_medication').click(function () {
            ...
            if (current1 < max) {
                $('.field_group2:first').clone(true).hide().insertAfter('.field_group2:last').slideDown(
                    'slow');
                var last = $('.field_group2:last');
                var current = $(".field_group2").length - 1;
                //last.append(new_button.clone(true));
                last.find('select').val([]);
                last.find('input.item_medication').attr("name", "medication_name[" + current +
                    "][name]").val('');
                last.find('select.seleect_medication').attr("name", "medication_name[" + current +
                    "][times_day]");
                last.find('select.select_medication').attr("name", "medication_name[" + current +
                    "][time]");
                current1++;
                return false;
            }
        ...
        $('#more_smoking').click(function () {
            ...
            if (current1 < max) {
                $('.field_groupUn:first').clone(true).hide().insertAfter('.field_groupUn:last')
                    .slideDown('slow');
                ...
                last.find('select.item_smoking_severity').attr("name", "smoking[" + current +
                    "][severity]");
                current1++;
                return false;
            }
