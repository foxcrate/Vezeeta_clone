...
@section('title','Child Old Presciption')
@section('content')
              ...
              <div class="tab-content" id="nav-tabContent">
                      ...
                      @if(auth()->guard('doctor')->user()->id == $rocata_child->doctor_id)
                        <div class="pills-main pills-main-yellow col-xl-9 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          ...
                          <div class="col-lg-3 mt-5">
                            <h5 class="font-weight-bold h3 text-uppercase">{{auth()->guard('clinic')->user()->clinicName}}</h5>
                          </div>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div class="header-body">
                        <div class="row pt-5">
                            @if($test_child)
                                  @foreach($test_child as $test)
                                      @if(auth()->guard('doctor')->user()->id == $test->doctor_id)
                                          <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                                              <div class="col-12">
                                                  <h5 class="mt-4 float-right">{{$test->created_at}}</h5>
                                              </div>
