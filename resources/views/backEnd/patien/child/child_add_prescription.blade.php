                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-3 text-center">
                                            <button class="col-10 btn btn-success h4 mt-sm-2"><a class = "text-white text-decoration" href="{{route('child_old_prescrption',[$clinic->id,$patient->id,$child->id])}}">Doctor Prescription </a></button>
                                        </div>
                                        <div class="col-3 text-center">
                                            <button class="col-10 btn btn-primary h4 mt-sm-2"><a class = "text-white text-decoration" href="{{route('child_all_prescrption',[$clinic->id,$patient->id,$child->id])}}">All Prescription </a></button>
                                        </div>
                                        <div class="col-12">
                                            <button class="col-3 float-right btn btn-danger h4 "><a class = "text-white text-decoration" href="{{route('clinic_doctor.logout',auth('doctor')->user()->id)}}">Log out </a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
