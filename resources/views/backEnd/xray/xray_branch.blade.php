        ...
        <div class="container-fluid" style="margin-top: 140px; margin-bottom: 100px;">
            <div class="header">
                <div class="container card p-5 ml-auto mr-auto">
                    ...
                    @endif
                    <form action = "{{route('xray_login_branch',$xray->id)}}" method="POST" class="col-8 ml-auto mr-auto">
                        {{ csrf_field() }}
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                <form action = "{{route('xray_add_branch',$xray->id)}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                    {{ csrf_field() }}
                                    {{-- {{dd($xray->id)}} --}}
                                    <input type="hidden" name = "xray_id" value="{{$xray->id}}">
