                ...
                <div class="container">
                    <div class="row no-gutters slider-text align-items-center justify-content-start"
                        ...
                        <div class="ml-2 col-md-12 pl-xl-0">
                            ...
                            <h3 class="h3 mb-4">Anytime, Everywhere, Healthy Life <i
                                    class="fa fa-heartbeat text-primary" aria-hidden="true"></i>.</h3>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="bg-login text-center col-md-10" Style="margin-bottom:50px;">
            ...
            <div class="row middle">
                <div class="col-lg-12 patein-radio">
                    <label class="m-2" onclick="displaySong()">
                        <input id="patien" type="radio" name="guard" value="patien" />
                        <div class="box patein-radio" checked>
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong6()">
                        <input id="online_doctor" type="radio" name="guard" value="online_doctor" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong7()">
                        <input id="nurse" type="radio" name="guard" value="nurse" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong2()">
                        <input id="hosptail" type="radio" name="guard" value="hosptail" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong1()">
                        <input id="clinic" type="radio" name="guard" value="clinic" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong5()">
                        <input id="pharmacy" type="radio" name="guard" value="pharmacy" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong4()">
                        <input id="labs" type="radio" name="guard" value="labs" />
                        <div class="box">
                            <script>
                    ...
                    <label class="m-2" onclick="displaySong3()">
                        <input id="xray" type="radio" name="guard" value="xray" />
                        <div class="box">
                            <script>
        ...
        <div class="container row ml-auto mr-auto mb-5">
            ...
            <div class="col-md-6 form">
                ...
                <p class="group" id="show_hide_password">
                    ...
                    <a id="show_hide_password" href="" class="field-icon"><i class="fa fa-eye-slash field-icon"
    ...
    <div class="text-account">
        ...
        <a href="{{url('/auth/redirect/google')}}"><img class="mt-2 mb-2 p-1" src="{{url('imgs/google.png')}}"
                width="260" alt="..."></a>
        <br>
        OR
        <br>
...
<script>
    ...
    btn.addEventListener("keypress", function (evt) {
        ...
        if (btn.value.length === 0 && (evt.keyCode <= 57 || evt.keyCode < 48 || (evt.keyCode != 80 && evt
                .keyCode != 68 && evt.keyCode != 72 && evt.keyCode != 67 && evt.keyCode != 88 && evt
                .keyCode != 76 && evt.keyCode != 89 && evt.keyCode != 78))) {
            console.log('no');
            evt.preventDefault();
