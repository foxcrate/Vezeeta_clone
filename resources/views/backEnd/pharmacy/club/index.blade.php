        ...
        <div class="main-content" id="panel">
            ...
            <div class="container">
                ...
                <div class="row col-lg-12 col-sm-6 mt-5 card-imgCard">
                  <div class="id-num ml-4 col-lg-10 h3 text-white">{{$pharmacy->idCode}}</div>
                  <div class="name-user ml-4 col-lg-10 h3 text-white">{{$pharmacy->pharmacyName}}</div>
                  <div class="date-exp ml-4 col-lg-5 h3 text-white">EXP 22/08</div>
                  <div class="point col-lg-5 h3 text-white">{{$pharmacy->poients}} Point</div>
                </div>
                <div class="row mt-5">
                    ...
                    <div class="skills-area">
                        <div class="single-skill col-lg-12 ml-auto mr-auto">
                            <div class="circlechart" data-percentage="92"><svg class="circle-chart" viewBox="0 0 33.83098862 33.83098862" xmlns="http://www.w3.org/2000/svg"><circle class="circle-chart__background" cx="16.9" cy="16.9" r="15.9"></circle>
                                <circle class="circle-chart__circle success-stroke" stroke-dasharray="{{$pharmacy->poients/5000*100}},5000" cx="16.9" cy="16.9" r="15.9"></circle><g class="circle-chart__info">
                                <text class="circle-chart__percent" x="16.9" y="14.5">{{$pharmacy->poients}}</text>
            ...
            <div class="row col-lg-8 ml-auto mr-auto mt-5">
              ...
              <table class="table">
                ...
                <tbody>
                    @foreach ($pharmacy->clupTransaction as $clup)
                        <tr>
    ...
    <script>
        function makesvg(percentage, inner_text=""){
           ...
           var svg = '<svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" xmlns="http://www.w3.org/2000/svg">'
               ...
               + 'stroke-dasharray="'+ abs_percentage+'{{ $pharmacy->poients/5000*100 }},5000" cx="16.9" cy="16.9" r="15.9" />'
