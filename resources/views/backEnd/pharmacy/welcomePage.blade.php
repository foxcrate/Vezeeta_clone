                        ...
                        <div class="header-body row">
                            <div class="col-md-4 mb-5 mt-5 text-center" style="margin-left: 50px;">
                                <h3 style="font-size:40pt; font-weight: bold; color: #0fAAc9; margin-bottom: 20px; ">Congratulation !</h1>
                                    ...
                                    <h6 class="h3 mb-3 font-weight-bold">{{'Welcome ' . $pharmacy->pharmacyName}}<span style="font-size:22pt; font-weight: bold; margin-bottom: 15px;" >{{$pharmacy->firstName . ' ' . $pharmacy->lastName}}</span></h6>
                                    <h6 class="h3 mb-5 font-weight-bold">Pharmacy ID <span style="font-size:22pt; font-weight: bold; margin-bottom:15px;" >{{$pharmacy->idCode}}</span></h6>
                                    <a href="{{route('pharmacy.homepage',$pharmacy->id)}}"><button class="btn btn-success h4 mt-3">Show Your Profile</button></a>
                            </div>
