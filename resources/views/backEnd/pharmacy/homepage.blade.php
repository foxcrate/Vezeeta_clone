...
@section('title','Pharmacy homepage')
@section('content')
<!--start-Navbar-->
...
<div class="bg-waves">
    ...
    <div class="container">
        ...
        <div class="col-2 mt-2">
            ...
            @else
                <img src="{{$pharmacy->image}}" class="rounded-circle" width="120" height="120">
            @endif
        </div>
        <div class="col-8">
        <h4 class="text-dark mt-3 mb-3 font-weight-bold">{{$pharmacy->pharmacyName . ' Pharmacy'}}</h4>
        <h5 class="text-dark">{{$pharmacy->idCode}}</h5>
        <div class="row mt-3">
            <h5 class="col-lg-4 text-dark">Classic Level</h5>
            <h5 class="col-lg-4 text-dark">{{ $pharmacy->poients }} Point</h5>
        </div>
        </div>
        <div class="col-2">
            <a href="{{route('pharmacy.edit.profile',$pharmacy->id)}}"><img src="{{url('imgs/edit.svg')}}" height="40" class="d-block w-100 mb-5" alt="..."></a>
    ...
    <div class="container row col-lg-6 ml-auto mr-auto text-center mt-5 mb-5">
        <div class="col-lg-3 ml-auto mr-auto">
            ...
            <a href="{{ route('pharmacy.profile',$pharmacy->id) }}"><img src="{{url('imgs/Patirnt.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
            </div>
        ...
        <div class="col-lg-3 ml-auto mr-auto">
            <div class="content-item ml-auto mr-auto">
            <a href="{{ route('pharmacy.qr.index',$pharmacy->id) }}"><img src="{{url('imgs/qrCode.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
            </div>
            <h5 class="text-dark font-weight-bold ml-auto mr-auto">QR Code</h5>
        </div>
        <div class="col-lg-3 ml-auto mr-auto">
            <div class="content-item ml-auto mr-auto">
              <a href="{{ route('pharmacy.orders',$pharmacy->id) }}"><img src="{{url('imgs/checklist.svg')}}" height="70" class="w-80 mt-3" alt="..."></a>
            </div>
            <h5 class="text-dark font-weight-bold ml-auto mr-auto">Orders</h5>
        </div>
        <div class="col-lg-3 ml-auto">
            <div class="content-item ml-auto mr-auto">
              <a href="{{ route('pharmacy.club',$pharmacy->id) }}"><img src="{{url('imgs/logo.svg')}}" height="90" class="d-block w-100 mt-2" alt="..."></a>
            </div>
