                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h6 font-weight-bold">Pharmacy Name <i class="fa fa-star-of-life star"></i></label>
                                        <input onkeypress="return /[a-z ]/i.test(event.key)" value = "{{old('pharmacyName')}}" class="form-control @error('pharmacyName') is-invalid @enderror" type="text" name="pharmacyName" placeholder="Pharmacy Name" style="text-transform:capitalize">
                                        @error('pharmacyName')
