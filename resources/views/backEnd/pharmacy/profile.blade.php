    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="header pb-6">
                <div class="container-fluid"  style="margin-top: 250px; margin-bottom: 150px;">
                <div class="header-body">
                    ...
                    <div class="col-xl-9 col-md-12 pt-2 pr-4 pl-4 pb-5 mr-auto ml-auto">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('pharmacy.patient.search',$pharmacy->id)}}" method="GET" value="P" style="text-transform:capitalize">
                            <div class="row m-1">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                ...
                                <div class="modal-body">
                                    <form action = "{{ route('pharmacy_add_patien',$pharmacy->id) }}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                        {{ csrf_field() }}
