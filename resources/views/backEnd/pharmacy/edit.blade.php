...
<div class="d-flex bg-page" id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div class="main-content" id="panel">
            ...
            <!-- Header -->
            <div class="row pt-3 col-11 ml-auto mr-auto mt-5">
                <div class="col-lg-12 col-md-4">
                    <img class="img-header" src="{{url('imgs/header.jpg')}}" }} >
                </div>
            </div>
            <!-- Page content -->
                ...
                <div class="col-xl-4 order-xl-2">
                  <div class="card card-profile">
                      ...
                      <div class="col-lg-3 order-lg-2">
                        <div class="card-profile-image">
                          <a href="#">
                              ...
                              @else
                                <img src="{{$pharmacy->image}}" class="rounded-circle">
                              @endif
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="col">
                          <div class="card-profile-stats d-flex justify-content-center">
                            <div>
                              ...
                              <h2 class="h3 text-gray mt-5">{{$pharmacy->pharmacyName}}</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="pr-2 pl-2">
                        <h5 class="row h5 mt-3">
                            <div class="col-lg-1">
                                <i class="fas fa-location-arrow mr-4 text-primary"></i>
                            </div>
                            <div class="col-lg-10">
                                {{$pharmacy->address}}
                            </div>
                        ...
                        <h5 class="row h5 mt-3">
                            <div class="col-lg-1">
                                <i class="fas fa-notes-medical mr-4 text-primary"></i>
                            </div>
                            <div class="col-lg-10">
                                {{$pharmacy->Medical_License_Number}}
                            </div>
                        </h5>
                        <h5 class="row h5 mt-3">
                            <div class="col-lg-1">
                                <i class="fas fa-mail-bulk mr-4 text-primary"></i>
                            </div>
                            <div class="col-lg-10">
                                {{$pharmacy->email}}
                            </div>
                        ...
                        <h5 class="row h5 mt-3">
                            <div class="col-lg-1">
                                <i class="fa fa-phone mr-4 text-primary" aria-hidden="true"></i>
                            </div>
                            <div class="col-lg-10">
                        ...
                        <h5 class="row h5 mt-3">
                            <div class="col-lg-1">
                                <i class="fas fa-tty mr-4 text-primary"></i>
                            </div>
                            <div class="col-lg-10">
                                {{$pharmacy->telephone}}
                            </div>
                        </h5>
                        <h5 class="row h5 mt-3 mb-5">
                            <div class="col-lg-1">
                                <i class="fas fa-hospital-alt mr-4 text-primary"></i>
                            </div>
                            <div class="col-lg-10">
                                {{$pharmacy->Hotline}}
                            </div>
                  ...
                  <div class="card" style="padding-left:100px; padding-right:100px;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('pharmacy.update.profile',$pharmacy->id)}}" id = "edit-pharmacy" data-id = "{{$pharmacy->id}}" enctype="multipart/form-data" role="form" action="" class="login-box" method="POST">
                            ...
                            <input type="hidden" id="latitude" name="latitude" value="{{ $pharmacy->latitude }}">
                            <input type="hidden" id="longitude" name="longitude" value="{{ $pharmacy->longitude }}">
                            <input type="hidden" name = "old_password" value="{{$pharmacy->password}}">
                            <input type="hidden" name="oldPhoneNumber" value="{{$pharmacy->phoneNumber}}">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h6 font-weight-bold">Pharmacy License <i class="fa fa-star-of-life star"></i></label>
                                        <input value="{{old('pharmacy_License')}}" class="form-control @error('pharmacy_License') is-invalid @enderror" type="file" placeholder="Pharmacy License" name="pharmacy_License">
                                ...
                                <div class="col-md-12 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input name="Medical_License_Number" type="text" value="{{ $pharmacy->Medical_License_Number }}" class="@error('labs_License') is-invalid @enderror form-control">
                                ...
                                <div class="col-md-12 xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{ str_replace($pharmacy->countryCode,'',$pharmacy->phoneNumber) }}" name="phoneNumber" type="text" placeholder="Phone Number" class="@error('phoneNumber') is-invalid @enderror form-control" style="padding-left: 200px">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{$pharmacy->Hotline}}" class="form-control" type="number" name="Hotline" placeholder="Hotline">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h5">Telephone</label>
                                        <input value = "{{$pharmacy->telephone}}" class="form-control" type="number" name="telephone" placeholder="Hotline">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="h5 font-weight-bold">Address</label>
                                        <input value="{{ $pharmacy->address }}" type="text" id="pac-input"class="form-control" name="address">
                                        <div id="map" style="width:100%;height:400px"></div>
                                    </div>
                                </div>
                                <div class="col-12 text-center mb-5 mt-5">
                                    <button type="submit" class=" col-9 btn btn-primary font-weight-bold mr-auto ml-auto">Submite</button>
                                </div>
                            </div>
                        </form>
                    </div>
