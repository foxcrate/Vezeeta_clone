        ...
        <div class="container-fluid" style="margin-top: 140px; margin-bottom: 100px;">
            <div class="header">
                <div class="container card p-5 ml-auto mr-auto">
                    ...
                    @endif
                    <form action = "{{route('pharmacy_login_branch',$pharmacy->id)}}" method="POST" class="col-8 ml-auto mr-auto">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group mt-5">
                            ...
                            <select class="col-12 form-control mt-3" name="Name">
                                ...
                                @foreach($pharmacy->branch as $branch)
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                <form action = "{{route('pharmacy_add_branch',$pharmacy->id)}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                    {{ csrf_field() }}
                                    {{-- {{dd($pharmacy->id)}} --}}
                                    <input type="hidden" name = "pharmacy_id" value="{{$pharmacy->id}}">
