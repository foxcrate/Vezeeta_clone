    ...
    <div id="page-content-wrapper">
        ...
        <div class="container mt-4">
            ...
            <div class="form-mywork mt-3">
                <form class="row col-10 ml-auto mr-auto" action="{{route('post_add_mywork')}}" method="POST">
                    {{ csrf_field() }}
                    <input type = "hidden" name="doctor_id" value="{{$online_doctor->id}}" >
                    <input type = "hidden" name="idCode" value="{{$online_doctor->idCode}}" >
                    <input type="hidden" name="doctor_name" value="{{$online_doctor->name}}">
                    ...
                    <di.v class="form-group col-lg-3">
                ...
                @foreach($online_doctor->appointments as $appoin)
                    <div class="label-work p-3 mb-5">
                        <div class="row col-10 ml-auto mr-auto text-center border-bottom pb-3">
                            <div class="col-lg-3 text-capitalize">{{$appoin->doctor_name}}</div>
                            <div class="col-lg-4">{{$appoin->address}}</div>
                            <div class="col-lg-2">Wating: {{$appoin->wating}}</div>
                            <div class="col-lg-2">Fees: {{$appoin->fees}}</div>
                        </div>
