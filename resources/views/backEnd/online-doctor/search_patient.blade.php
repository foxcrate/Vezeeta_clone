                ...
                <div class="col-lg-10 mr-auto ml-auto">
                  <div class="card card-stats">
                    ...
                    <div class="card-body">
                      ...
                      <form action="{{route('post_doctor_search_patient',$online_doctor->id)}}" method="GET">
                        <div class="row m-1">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                ...
                                <div class="modal-body">
                                    <form action = "{{ route('online_doctor_add_patient',$online_doctor->id) }}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                        {{ csrf_field() }}
