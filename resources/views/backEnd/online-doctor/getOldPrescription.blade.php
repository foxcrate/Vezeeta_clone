    ...
    <div id="page-content-wrapper">
        ...
        <div class="container row col-12 ml-auto mr-auto mt-5">
            <ul class="nav nav-pills col-7 ml-auto mr-auto mb-3" id="pills-tab" role="tablist">
                ...
                {{-- <li class="nav-item" role="presentation">
                  <a class="nav-link search-pres" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Analysis Test
                </a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link search-pres" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Radiology</a>
                </li> --}}
            </ul>
            <div class="container">
                            ...
                            <div class="row col-12 pt-5">
                                ...
                                @if($patient->Raoucheh)
                                    @foreach($patient->Raoucheh as $Raoucheh)
                                        <div class="new-icon">
                                            <a href="{{ route('getAnalzesWhenRocata',[$online_doctor->id,$Raoucheh->id,$patient->id]) }}" title="Click Rays"><img src="{{ url('imgs/new-icon/ray.jpg') }}" alt=""></a>
                                            <a href="{{ route('getRaysWhenRocata',[$online_doctor->id,$Raoucheh->id,$patient->id]) }}" title="Click Tests"><img src="{{ url('imgs/new-icon/test.jpg') }}" alt=""></a>
                                        </div>
                                        @if(auth()->guard('online_doctor')->user()->id == $Raoucheh->online_doctor_id)
                                            <div class="pills-main pills-main-yellow col-lg-9 row mb-4 mr-auto ml-auto">
                                                <div class="row col-lg-8 ml-5 mt-5">
                                                    <div class="row col-lg-12">
                                                        ...
                                                        <div class="col-5">
                                                            <h5 class="">{{auth()->guard('online_doctor')->user()->name}}</h5>
                                                        </div>
                                                    </div>
                                                    <div class="row col-12 ">
                                                        ...
                                                        <div class="col-5">
                                                            <h5 class="">{{auth()->guard('online_doctor')->user()->special->name}}</h5>
                                                        </div>
                                                    </div>
                                                    <div class="row col-12 ">
                                                        <div class="col-4">
                            ...
                            <div class="row col-12 pt-5">
                                @if($patient->patient_analzes)
                                    @foreach($patient->patient_analzes as $p_analzes)
                                        @if(auth()->guard('online_doctor')->user()->id == $p_analzes->online_doctor->id)
