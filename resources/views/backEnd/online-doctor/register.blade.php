            ...
            <div class="col-md-10">
                <form action="{{route('postonlineDoctorRegister')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-12 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phoneNumber" class="form-control @error('phoneNumber') is-invalid @enderror" value="{{old('phoneNumber')}}" placeholder="Phone Number" style="padding-left: 260px">
                    ...
                    <div class="col-12 text-center mb-5 mt-5">
                        <input type="submit" id = "sign-in-button" disabled class="h4 col-9 btn btn-primary font-weight-400 mr-auto ml-auto" >
                    </div>
                </form>
            </div>
        </div>
