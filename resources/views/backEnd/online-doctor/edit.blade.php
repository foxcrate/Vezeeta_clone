...
<div class="d-flex bg-veiwdoctor" id="wrapper">
    <div id="page-content-wrapper">
        ...
        <div class="container row col-8 ml-auto mr-auto">
            ...
            @endif
            <form action="{{route("online_doctor.update",$online_doctor->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="hidden" id="latitude" name="latitude" value="{{ $online_doctor->latitude }}">
                <input type="hidden" id="longitude" name="longitude" value="{{ $online_doctor->longitude }}">
                <input type="hidden" id="online_doctor_id" value="{{$online_doctor->id}}">
                <input type="hidden" name="password" value="{{$online_doctor->password}}">
                <input type="hidden" name="idCode" value="{{$online_doctor->idCode}}">
                <input type="hidden" name="oldPhoneNumber" value="{{ $online_doctor->phoneNumber }}">
                <div class="avatar-wrapper mt-5">
                    <img class="profile-pic" src="{{ $online_doctor->image }}" name = "image"/>
                ...
                <div class="row mt-5">
                    {{--  <div class="col-lg-6 form-group">
                        <label class="h6 font-weight-bold">Doctor Name</label>
                        <input value="{{$online_doctor->name}}"type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" placeholder="Doctor Full Name">
                        @error('name')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>  --}}
                    {{--  <div class="col-lg-6 form-group">
                        <label class="h6 font-weight-bold">Degree</label>
                        <select class="form-control @error('degree') is-invalid @enderror" placeholder="degree" name="degree">
                            <option value="">Chosse .. </option>
                            <option {{$online_doctor->degree == "MD" ? 'selected':''}} value="MD">MD</option>
                            <option {{$online_doctor->degree == "BSC" ? 'selected':''}} value="BSC">BSC</option>
                            <option {{$online_doctor->degree == "MSC" ? 'selected':''}} value="MSC">MSC</option>
                            <option {{$online_doctor->degree == "PsyD" ? 'selected':''}} value="PsyD">PsyD</option>
                            <option {{$online_doctor->degree == "PhD" ? 'selected':''}} value="PhD">PhD</option>
                            <option {{$online_doctor->degree == "MDCM" ? 'selected':''}} value="MDCM">MDCM</option>
                            <option {{$online_doctor->degree == "DO" ? 'selected':''}} value="DO">DO</option>
                            <option {{$online_doctor->degree == "MBBS" ? 'selected':''}} value="MBBS">MBBS</option>
                            <option {{$online_doctor->degree == "MBChB" ? 'selected':''}} value="MBChB">MBChB</option>
                            <option {{$online_doctor->degree == "DDS" ? 'selected':''}} value="DDS">DDS</option>
                            <option {{$online_doctor->degree == "DPM" ? 'selected':''}} value="DPM">DPM</option>
                            <option {{$online_doctor->degree == "EdD" ? 'selected':''}} value="EdD">EdD</option>
                            <option {{$online_doctor->degree == "PharmD" ? 'selected':''}} value="PharmD">PharmD</option>
                        </select>
                        @error('degree')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    {{--  <div class="col-md-12 mb-xl-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('information') is-invalid @enderror" row = "4" cols="10" name="information" style="resize: none" placeholder="Medical Description">{{$online_doctor->information}}</textarea>
                            @error('information')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12 xl-3">
                        <div class="form-group">
                            ...
                            <input value = "{{ str_replace($online_doctor->countryCode,'',$online_doctor->phoneNumber)}}" name="phoneNumber" type="text" placeholder="Phone Number" class="@error('phoneNumber') is-invalid @enderror form-control" style="padding-left: 280px">
                    ...
                    <div class="col-md-6 mb-xl-3">
                        <div class="form-group">
                            <label class="h6 font-weight-bold">Primary Speciality</label>
                            <select class="form-control @error('Primary_Speciality') is-invalid @enderror" type="text" name="speciality_id" placeholder="Primary Speciality">
                                ...
                                @foreach($doctorSp as $sp)
                                    <option {{$online_doctor->speciality_id == $sp->id ? 'selected' : ''}} value="{{$sp->id}}">{{$sp->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 mb-xl-3">
                        <div class="form-group">
                            ...
                            <input value="{{$online_doctor->email}}"type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Nationality">
                            @error('email')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-xl-3">
                        <div class="form-group">
                            <label class="h6 font-weight-bold">license Image <i class="fa fa-star-of-life star"></i></label>
                    ...
                    <div class="col-md-6 mb-xl-3">
                        <div class="form-group">
                            <label class="h6 font-weight-bold">Medical_License_Number<i class="fa fa-star-of-life star"></i></label>
                            <input name="license_number" type="text" value="{{ $online_doctor->license_number }}" class="@error('labs_License') is-invalid @enderror form-control">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="pac-input"class="form-control" name="address" value="{{$online_doctor->address}}">
