...
<div class="row">
    <div class="col-12">
        <div class="container">
            <form action = "{{route('efelate_post_Register',$efelatePatien->id)}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box" style="margin-top:70px">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-xl-3">
                        <div class="form-group">
                            ...
                            <input value = "{{old('phoneNumber')}}" name="phoneNumber" type="number" placeholder="Phone Number" class="@error('phoneNumber') is-invalid @enderror form-control" style="padding-left: 342px">
