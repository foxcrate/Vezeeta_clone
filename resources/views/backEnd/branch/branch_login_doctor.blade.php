...
<!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid" style="margin-top: 140px; margin-bottom: 100px;">
            <div class="header">
                <div class="container card p-5 ml-auto mr-auto">
                    ...
                    <form action = "{{route('branch_post_login_doctor',[$hosptail->id,$branch->id])}}" method="POST" class="col-8 ml-auto mr-auto">
                        {{@csrf_field()}}
        ...
        <div class="row container ml-auto mr-auto">
            <div class="col-4">
                <div class="row" style="margin-bottom:100px;">
                    <div class="col-2"><a type="button" class="cursor" data-toggle="modal" data-target="#exampleModal"><img src="{{url('imgs/2.svg')}}" width="80" /></a></div>
                    <div class="d-inline-block col-8 ml-4 mt-auto mb-auto cursor" data-toggle="modal" data-target="#exampleModal"><p class="h4 text-primary ml-3">Add New Doctor</p></div>
                </div>
                <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"  style="padding-left:40px; padding-right:40px;">
                                <form action="{{route('branch_add_doctor',[$hosptail->id,$branch->id])}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                ...
                <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                <!-- form -->
                                <form action = "{{route('branch_add_patient',[$hosptail->id,$branch->id])}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                    {{ csrf_field() }}
                                    {{-- {{dd($hosptail->id)}} --}}
                                    <input type="hidden" name = "hosptail_id" value="{{$hosptail->id}}">
        ...
        <!-- add new branch -->
            ...
            <div class="col-4">
                <div class="row" style="margin-bottom:100px;">
                    <div class="col-2"><a type="button" class="cursor" data-toggle="modal" data-target="#exampleModal2"><img src="{{url('imgs/3.svg')}}" width="80" /></a></div>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                <!-- form -->
                                <form action = "{{route('branch_doctor_departement',[$hosptail->id,$branch->id])}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                    {{ csrf_field() }}
                                    {{-- {{dd($hosptail->id)}} --}}
                                    {{-- <input type="hidden" name = "hosptail_id" value="{{$hosptail->id}}"> --}}
                                    {{-- <input type="hidden" name="role">
