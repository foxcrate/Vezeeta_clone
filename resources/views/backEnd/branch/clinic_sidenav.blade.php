...
<div class="left-menu bg-white border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush mt-5">
        <a href="{{route('clinic_getAsBranch',[$clinic->id,$branch->id])}}" class="list-group-item list-group-item-action h5"><i class="fa fa-home mr-2" aria-hidden="true"></i> Home</a>
        <a href="#" class="list-group-item list-group-item-action h5"><i class="fas fa-user-edit mr-2"></i> Edit Profile</a>
        <div class="dropdown">
            <a href="#" class="list-group-item list-group-item-action h5 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-users mr-2"></i> Future <i class="fas fa-tools text-dark float-right mr-3"></i></a>
        ...
        <a href="#" class="list-group-item list-group-item-action mb-5 h5"><i class="fas fa-sign-out-alt mr-2"></i> Logout</a>
        <a href="About.html" class="list-group-item list-group-item-action h5 mt-4">About</a>
        
        {{-- <a href="About.html" class="list-group-item list-group-item-action h5 ">Privacy policy</a> --}}
        <a href="ContactUs.html" class="list-group-item list-group-item-action h5">Help</a>
        <a href="About.html" class="list-group-item list-group-item-action h5 ">FeedBack</a>
