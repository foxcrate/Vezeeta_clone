        ...
        <div class="container-fluid" style="margin-top: 210px; margin-bottom: 170px;">
          ...
          <h2 class="text-white ml-5 mt-5">Choose a Login With ... </h2>
            <div class="container-fluid row mt-5 mb-5 text-center">
              ...
              <div class="col-md-3">
                <a href="{{route('xray.profile',$xray->id)}}"><img class="img-x-ray" src="{{url('imgs/xray0.png')}}" height="" width="170" alt="Responsive image"></a>
              </div>
              
              @if($branch->is_lab == 1)
              <div class="col-md-3">
                <a href="#"><img class="img-labs" src="{{url('imgs/labs0.png')}}" height="" width="170" alt="Responsive image"></a>
              </div>
              @endif
            </div>
          </div>
