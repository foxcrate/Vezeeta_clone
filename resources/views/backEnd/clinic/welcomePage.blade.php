                        ...
                        <div class="header-body row">
                            <div class="col-md-5 mb-5 mt-5 text-center">
                                <h3 style="font-size:40pt; font-weight: bold; color: #0fAAc9; margin-bottom: 20px; ">Congratulation !</h1>
                                    ...
                                    <h6 class="h3 mb-3 font-weight-bold">Welcome <span style="font-size:22pt; font-weight: bold; margin-bottom: 15px;" >{{$clinic->clinicName}}</span></h6>
                                    <h6 class="h3 mb-5 font-weight-bold">Clinic <span style="font-size:22pt; font-weight: bold; margin-bottom:15px;" >{{$clinic->idCode}}</span></h6>
                                    <a href="{{route('clinic.homepage',$clinic->id)}}"><button class="btn btn-success h4 mt-3">Show Your Profile</button></a>
                            </div>
