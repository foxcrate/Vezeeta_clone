                        ...
                        <div class="card-finder">
                            <div class="row mr-auto ml-auto">
                                <div class="col-lg-10">
                                    ...
                                    <form action="{{ route('clinicBookDocApp',$clinic->id) }}" method="POST">
                                        {{ csrf_field() }}
                                        <div class="row get_work mb-3">
                                            <input type="hidden" name="doctor_id" value="{{ $doctor->doctor_id }}">
                                            <select name="appointments[0][time]" id="" class="get_day col-9 ml-3 form-control">
                                                @if($days)
                                                    @foreach($days as $day)
                                            ...
                                            <input type="time" name="from" class="get_from col-4 ml-3 mt-2 form-control">
                                            <input type="time" name="to" class="get_to col-4 mt-2 ml-3 form-control">
                                        </div>
                                        <label>Fees</label>
