...
<div id="page-content-wrapper">
    ...
    <!-- informationContent -->
    <div class="container-fluid">
        <div class="header" style="margin-top: 120px; margin-bottom: 120px;">
            <div class="container-fluid">
              <div class="header-body">
                <div class="row mt-3">
                  <div class="col-lg-10 mr-auto ml-auto p-5">
                  <div class="text-center mb-5"><img src="{{url('imgs/xray0.png')}}" height="" width="170" alt="Responsive image"></div>
                    <div class="card  card-stats">
                      <!-- Card body -->
                      <div class="card-body">
                        <h5 class="col-8 mr-auto ml-auto font-weight-bold p-4">Enter ID Patient</h5>
                        @foreach($errors->all() as $error)
                        <div class="col-8 mr-auto ml-auto alert alert-danger">{{$error}}</div>
                        @endforeach
                        <form action="{{route('clinic_post_search_xray',$clinic->id)}}" method="GET">
                            <div class="row m-1">
                                ...
                                <button class="btn btn-primary h3 col-md-12"><i class="fa fa-search mr-2" aria-hidden="true"></i>Search</button>
                                </div>
                            </div>
                        </form>
                      </div>
