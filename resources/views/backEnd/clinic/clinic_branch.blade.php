        ...
        <div class="container-fluid" style="margin-top: 140px; margin-bottom: 100px;">
            <div class="header">
                <div class="container card p-5 ml-auto mr-auto">
                    ...
                    @endif
                    <form action = "{{route('clinic_login_branch',$clinic->id)}}" method="POST" class="col-8 ml-auto mr-auto">
                        {{ csrf_field() }}
        ...
        <div class="row container ml-auto mr-auto">
            ...
            <div class="col-4">
                <div class="row" style="margin-left:100px; margin-bottom:100px;">
                    <div class="col-1"><a type="button" class="cursor" data-toggle="modal" data-target="#exampleModalk"><img src="{{url('imgs/4.svg')}}" width="80" /></a></div>
                    <div class="d-inline-block mt-auto mb-auto cursor" data-toggle="modalp" data-target="#exampleModalk"><p class="h4 text-primary ml-3">Add New Branch</p></div>
                </div>
                <!-- Modal -->
