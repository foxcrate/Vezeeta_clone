                        ...
                        <div class="pills-main pills-main-yellow col-xl-9 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          <div class="row col-lg-8 ml-5 mt-5">
                            <div class="row col-lg-12">
                              ...
                              <div class="col-5">
                                <h5 class="">{{$Raoucheh->doctor->name}}</h5>
                              </div>
                            </div>
                          ...
                          <div class="col-lg-3 mt-5">
                            <h5 class="font-weight-bold h3 text-uppercase">
                              {{$Raoucheh->doctor->clinic ? $Raoucheh->doctor->clinic->clinicName :$Raoucheh->doctor->hosptail->hosptailName }}
                            </h5>
                          </div>
