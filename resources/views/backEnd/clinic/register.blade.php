                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        <label class="h6 font-weight-bold">Clinic Name <i class="fa fa-star-of-life star"></i></label>
                                        <input onkeypress="return /[a-z ]/i.test(event.key)" class="form-control @error('clinicName') is-invalid @enderror" type="text" name="clinicName" placeholder="Clinic Name" value = "{{old('clinicName')}}" style="text-transform:capitalize">
                                        @error('clinicName')
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('Primary_Speciality') is-invalid @enderror" type="text" name="Primary_Speciality" value = "{{old('Primary_Speciality')}}">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('Medical_License_Number')}}" class="form-control @error('Medical_License_Number') is-invalid @enderror" type="text" placeholder="Medical License Number" name="Medical_License_Number">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('phoneNumber')}}" class="form-control @error('phoneNumber') is-invalid @enderror" type="number" name="phoneNumber" placeholder="Phone Number" style="padding-left: 200px">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('telephone')}}" class="form-control @error('telephone') is-invalid @enderror" type="number" name="telephone" placeholder="Telephone">
                                        @error('telephone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('Hotline')}}" class="form-control @error('Hotline') is-invalid @enderror" type="number" name="Hotline" placeholder="Hotline">
                                        @error('Hotline')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                {{--  <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('country')}}" class="form-control @error('country') is-invalid @enderror" type="text" name="country" placeholder="Country">
                                        @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('city')}}" class="form-control @error('city') is-invalid @enderror" type="text" name="city" placeholder="City">
                                        @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('area')}}" class="form-control @error('area') is-invalid @enderror" type="text" name="area" placeholder="Area">
                                        @error('area')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('street')}}" class="form-control @error('street') is-invalid @enderror" type="text" name="street" placeholder="Street">
                                        @error('street')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('zip_code')}}" class="form-control @error('zip_code') is-invalid @enderror" type="text" name="zip_code" placeholder="ZIP Code">
                                        @error('zip_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input id="txtEmailId" value = "{{old('email')}}" class="form-control @error('email') is-invalid @enderror" type="email" name="email" placeholder="email@example.com">
                                ...
                                <div class="col-12 text-center mb-5 mt-5">
                                    ...
                                    <button type="submit" disabled id = "sign-in-button" class=" col-9 btn btn-primary font-weight-600 h3 mr-auto ml-auto">Submite</button>
                                </div>
                            </div>
                        </form>
                    </div>
