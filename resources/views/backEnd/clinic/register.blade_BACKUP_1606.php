                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('clinicName') is-invalid @enderror" type="text" name="clinicName" placeholder="Clinic Name" value = "{{old('clinicName')}}">
                                        @error('clinicName')
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('Clinic_License')}}" class="form-control @error('Clinic_License') is-invalid @enderror" type="file" placeholder="Clinic License" name="Clinic_License">
                                ...
                                <div class="col-md-10 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('phoneNumber')}}" class="form-control @error('phoneNumber') is-invalid @enderror" type="text" name="phoneNumber" placeholder="Phone Number" style="padding-left: 220px">
                                        @error('phoneNumber')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('telephone')}}" class="form-control @error('telephone') is-invalid @enderror" type="text" name="telephone" placeholder="Telephone">
                                        @error('telephone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-xl-3">
                                    <div class="form-group">
                                        ...
                                        <input value = "{{old('Hotline')}}" class="form-control @error('Hotline') is-invalid @enderror" type="text" name="Hotline" placeholder="Hotline">
                                        @error('Hotline')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 mb-xl-3">
                                    ...
                                    <label class="h5 ml-3 ">Add pharmacy</label>
                                </div>
                                <div class="col-md-12 mb-xl-3">
                                    <hr class="my-4" />
                                    <div class="">
...
<<<<<<< HEAD
                                    <button type="submit" id="sign-in-button" disabled class=" col-9 btn btn-primary font-weight-600 h3 mr-auto ml-auto">Submite</button>
=======
...
>>>>>>> a18de26272ccff0400678712b7b521809c3f514e
                                </div>
                            </div>
                        </form>
                    </div>
