                    ...
                    <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media align-items-center">
                        <span class="avatar avatar-sm rounded-circle">
                          <img alt="Image placeholder" src="@if($clinic->image) {{url('uploads/lab/' . $clinic->image)}} @else {{url('uploads/' . $clinic->image)}}@endif">
                        </span>
                      ...
                      <div class="col-md-12">
                        <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          ...
                          <div class="row col-12 mb-3">
                            ...
                            <div class="col-10">
                                <form action="{{route('add_result_ray',$clinic->id)}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                        ...
                        <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          ...
                          <div class="row col-12 mb-3">
                            ...
                            <div class="col-10">
                                ...
                                <form action="{{route('clinic_child_add_Result_rays',$clinic->id)}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
