                      ...
                      <div class="pills-main-yellow col-xl-10 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                        ...
                        <div class="row col-12 mb-3">
                          ...
                          <div class="col-10 ml-auto mr-auto">
                              <form action="{{route('add_result_test',$clinic->id)}}" multiple="multiple" method="POST" enctype="multipart/form-data">
                                  {{csrf_field()}}
                      ...
                      <div class="pills-main-yellow col-xl-10 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                        ...
                        <div class="row col-12 mb-3">
                          ...
                          <div class="col-10 ml-auto mr-auto">
                              ...
                              <form action="{{route('clinic_child_add_Result_test',$clinic->id)}}" multiple="multiple" method="POST" enctype="multipart/form-data">
                                  {{csrf_field()}}
