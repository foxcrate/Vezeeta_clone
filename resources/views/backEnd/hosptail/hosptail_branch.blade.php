                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            <div class="col-auto mb-3">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="@if($hosptail->image) {{url('uploads/hosptail/' . $hosptail->image)}} @else {{url('uploads/' . $hosptail->image)}}@endif" class="avatar rounded-circle">
                                            </div>
                                            <div class="col ml--2">
        ...
        <div class="container-fluid" style="margin-top: 140px; margin-bottom: 100px;">
            <div class="header">
                <div class="container card p-5 ml-auto mr-auto">
                    ...
                    @endif
                    <form action = "{{route('hosptail_login_branch',$hosptail->id)}}" method="POST" class="col-8 ml-auto mr-auto">
                        {{ csrf_field() }}
