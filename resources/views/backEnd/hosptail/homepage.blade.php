...
<div class="bg-waves">
    ...
    <div class="container">
        ...
        <div class="col-8">
        <h4 class="mt-3 mb-3 font-weight-bold">{{$hosptail->hosptailName . ' hosptail'}}</h4>
        <h5 class="">{{$hosptail->idCode}}</h5>
        <div class="row mt-3">
            <h5 class="col-lg-4">Classic Level</h5>
            <h5 class="col-lg-4">{{ $hosptail->poients }} Point</h5>
        </div>
        </div>
        <div class="col-2">
            <a href="{{route('hosptail.edit.profile',$hosptail->id)}}"><img src="{{url('imgs/edit.svg')}}" height="40" class="d-block w-100 mb-5" alt="..."></a>
    ...
    <div class="container row col-lg-6 ml-auto mr-auto text-center mt-5 mb-5">
        <div class="col-lg-3 ml-auto mr-auto">
            ...
            <a href="{{ route('loginDoctor',$hosptail->id) }}"><img src="{{url('imgs/doctorfamily.svg')}}" height="80" class="d-block w-100 mt-2" alt="..."></a>
            </div>
        ...
        <div class="col-lg-3 ml-auto mr-auto">
            <div class="content-item ml-auto mr-auto">
            <a href="{{ route('hosptaildoctorAppoiement',$hosptail->id) }}"><img src="{{url('imgs/calendar.png')}}" height="80" class="w-80 mt-2" alt="..."></a>
            </div>
            <h5 class="text-dark font-weight-bold ml-auto mr-auto">Appoiement</h5>
        </div>
        <div class="col-lg-3 ml-auto mr-auto">
            <div class="content-item ml-auto mr-auto">
              <a href="{{route('hosptail.logout')}}"><img src="{{url('imgs/logout.png')}}" height="70" class="w-80 mt-3" alt="..."></a>
            </div>
