...
<div class="d-flex bg-page" id="wrapper">
    ...
    <nav class="navbarp navbar-top navbar-expand navbar-dark p-2">
        ...
        <div class="container-fluid">
                            ...
                            <div class="pills-main card p-3 card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                           <a href="{{route('hosptail_get_patien_profile',[$hosptail->id,$patient->id])}}"><h4 class="text-black card-title text-uppercase mb-3">{{$patient->firstName . ' ' . $patient->lastName}}</h4></a>
                                        ...
                                        <div class="col-3 text-center">
                                            <button class="col-10 btn btn-success h4 mt-sm-2"><a class = "text-white text-decoration" href="{{route('hosptail_old_prescription',[$hosptail->id,$patient->id])}}">Doctor Prescription </a></button>
                                        </div>
                                        <div class="col-3 text-center">
                                            <button class="col-10 btn btn-primary h4 mt-sm-2"><a class = "text-white text-decoration" href="{{route('getAllPrescription',[$hosptail->id,$patient->id])}}">All Prescription </a></button>
                                        </div>
                                        <div class="col-12">
                                            <button class="col-3 float-right btn btn-danger h4 "><a class = "text-white text-decoration" href="{{route('doctor.logout',$doctor->id)}}">Log out </a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <form action="{{route("store_hosptail_Raoucata")}}" id="hosptail_add_prescription" method="POST">
                {{csrf_field()}}
