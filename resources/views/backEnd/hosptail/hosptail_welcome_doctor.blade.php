                        ...
                        <div class="header-body row">
                            <div class="col-md-5 mb-5 mt-5 text-center">
                                <h3 style="font-size:40pt; font-weight: bold; color: #5bb05d; margin-bottom: 20px; ">Congratulation !</h1>
                                    ...
                                    <h6 class="h3 mb-5 font-weight-bold">Doctor ID <span style="font-size:22pt; font-weight: bold; margin-bottom:15px;" >{{str_replace('+','D',$doctor->IdCode)}}</span></h6>
                                    <a href="{{route('hosptail.profile',$hosptail->id)}}"><button class="btn btn-success h4 mt-3">Show Your Profile</button></a>
                            </div>
