                    ...
                    <div class="row">
                        <div class="container col-md-12 mb-5">
                            <div class="avatar-wrapper ">
                                <img class="hospital-pic" src="" name = "image"/>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h6 font-weight-bold">Hospital Name <i class="fa fa-star-of-life star"></i></label>
                                <input onkeypress="return /[a-z ]/i.test(event.key)" value = "{{old('hosptailName')}}" class="form-control @error('hosptailName') is-invalid @enderror" type="text" name="hosptailName" placeholder="Hospital Name" style="text-transform:capitalize">
                                @error('hosptailName')
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input  value = "{{old('Medical_License_Number')}}" name = "Medical_License_Number" class="form-control @error('Medical_License_Number') is-invalid @enderror" type="text" placeholder="Medical License Namber">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input value="{{old('Hosptail_License')}}" class="form-control @error('Hosptail_License') is-invalid @enderror" type="file" placeholder="Hospital License" name="Hosptail_License">
                        ...
                        <!-- address field -->
                        {{-- <label class="col-12 h6 font-weight-bold mt-3 mb-4">Add Dapartment</label>
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="hosptail_labs" value="1">
                            <label class="h6 ml-3 font-weight-bold text-dark">Add Labs</label>
                        </div>
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="hosptail_xray" value="1">
                            <label class="h6 ml-3 font-weight-bold text-dark">Add Xray</label>
                        </div>
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="hosptail_pharmacy" value="1">
                            <label class="h6 ml-3 font-weight-bold text-dark">Add Pharmacy</label>
                        </div> --}}
                        <div class="col-md-12 mb-xl-3">
                            <hr class="my-4" />
                            <div class="">
                                <input type="checkbox" name="i_agree" id="i_agree">
                                <label class="p font-weight-bold" style="font-size: .98rem;">I have read and I understand the  <a target="_blank" class="text-primary" href="{{route('getPrivacyRegister')}}">pHistroy privacy policy statement</a>, I agree on all terms and conditions.</a></label>
                            </div>
                        </div>
                        {{--<div class = "col-12">--}}
                        {{--<a href="{{route('mymap')}}"><lable>Address</lable></a>--}}
                        {{--</div>--}}
                        <div class="col-12 text-center mb-5 mt-5">
                            <button type="submit" disabled id = "sign-in-button" class=" col-9 btn btn-primary font-weight-400 h3 mr-auto ml-auto">Submite</button>
                        </div>
                    </div>
                </form>
            </div>
