            ...
            <div class="container-fluid" style="margin-top: 210px; margin-bottom: 170px;">
              ...
              <h2 class="text-white ml-5 mt-5">Choose a Login With ... </h2>
                <div class="container-fluid row mt-5 mb-5 text-center">
                  <div class="col-md-3">
                    <a href="{{route('loginDoctor',$hosptail->id)}}"><img class="" src="{{url('imgs/doctor0.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @if($hosptail->hosptail_xray == 1)
                  <div class="col-md-3">
                    <a href="{{route('get_search_xray',$hosptail->id)}}"><img class="" src="{{url('imgs/xray0.png')}}" height="" width="150" alt="Responsive image"></a>
                  ...
                  <div class="col-md-3">
                    <a href="{{route('get_search_lab',$hosptail->id)}}"><img class="" src="{{url('imgs/labs0.png')}}" height="" width="150" alt="Responsive image"></a>
                  ...
                  <div class="col-md-3">
                    ...
                    <a href="{{route('get_search_pharmacy',$hosptail->id)}}"><img class="" src="{{url('imgs/pharm1.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @endif
                </div>
              </div>
            ...
            <div class="row container ml-auto mr-auto">
              ...
              <div class="col-3">
                  <div class="row" style="margin-bottom:100px;">
                      <div class="col-2">
                        <a type="button" data-toggle="modal" class="cursor" data-target="#exampleModal"><img src="{{url('imgs/2.svg')}}" width="80" /></a>
                        </div>
                      <div class="d-inline-block col-8 ml-4 mt-auto mb-auto cursor" data-toggle="modal" data-target="#exampleModal"><p class="h4 text-white ml-3">New Doctor</p></div>
                  </div>
                  <!-- Modal -->
                                  ...
                                  <form action="{{route('hosptail_add_doctor',$hosptail->id)}}" method="POST" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" name="branch">
                                              ...
                                              @foreach($hosptail->branch as $branch)
              ...
              <div class="col-3">
                  <div class="row" style="margin-bottom:100px;">
                      <div class="col-2">
                        <a type="button" class="cursor" data-toggle="modal" data-target="#exampleModal1"><img src="{{url('imgs/1.svg')}}" width="80" /></a>
                      </div>
                      <div class="d-inline-block col-8 ml-4 mt-auto mb-auto cursor" data-toggle="modal" data-target="#exampleModal1"><p class="h4 text-white ml-3">New Patient</p></div>
                  </div>
                  <!-- Modal -->
                  <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                  <!-- form -->
                                  <form action = "{{route('hosptail_add_patien')}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                      {{ csrf_field() }}
                                      {{-- {{dd($hosptail->id)}} --}}
                                      <input type="hidden" name = "hosptail_id" value="{{$hosptail->id}}">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6 mb-xl-3">
                                              <div class="form-group">
                                                  ...
                                                  <select name="jop" class="form-control">
                                                    {{--  <option value="">Choose</option>  --}}
              ...
              <div class="col-3">
                  <div class="row" style="margin-bottom:100px;">
                      <div class="col-2">
                        <a type="button" class="cursor" data-toggle="modal" data-target="#exampleModal2"><img src="{{url('imgs/4.svg')}}" width="80" /></a>
                      </div>
                      <div class="d-inline-block col-8 ml-4 mt-auto mb-auto cursor" data-toggle="modal" data-target="#exampleModal2"><p class="h4 text-white ml-3">New Branch</p></div>
                  </div>
                  <!-- Modal -->
                  <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabe2">Add new Branch</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                  </button>
                              </div>
                              <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                  <!-- form -->
                                  <form action = "{{route('hosptail_add_branch',$hosptail->id)}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                      {{ csrf_field() }}
                                      {{-- {{dd($hosptail->id)}} --}}
                                      <input type="hidden" name = "hosptail_id" value="{{$hosptail->id}}">
                                      {{-- <input type="hidden" name="role">
              ...
              <div class="col-3">
                  <div class="row" style="margin-bottom:100px;">
                      <div class="col-2">
                        <a type="button" class="cursor" data-toggle="modal" data-target="#exampleModal4"><img src="{{url('imgs/3.svg')}}" width="80" /></a>
                      </div>
                  ...
                  <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe4" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body" style="padding-left:40px; padding-right:40px;">
                                  <!-- form -->
                                  <form action = "{{route('hosptail_add_dapartement',$hosptail->id)}}" method="POST" id = "register" enctype="multipart/form-data" class="login-box">
                                      {{ csrf_field() }}
                                      {{-- {{dd($hosptail->id)}} --}}
                                      <input type="hidden" name = "hosptail_id" value="{{$hosptail->id}}">
                                      <div class="row">
                                          ...
                                          <label class="col-12 h5 font-weight-bold mt-3 mb-4">Add Dapartment</label>
                                          <div class="col-md-4 mb-xl-3">
                                              <input type="checkbox" name="hosptail_lab" value="1">
                                              <label class="h5 ml-3 font-weight-bold text-dark">Labs</label>
                                          </div>
                                          <div class="col-md-4 mb-xl-3">
